$PBExportHeader$w_infodisp.srw
$PBExportComments$[nvo_printing] Displays information about the current operation.
forward
global type w_infodisp from window
end type
type progress_bar from u_progress within w_infodisp
end type
type st_1 from statictext within w_infodisp
end type
type st_build from statictext within w_infodisp
end type
type st_ldr from statictext within w_infodisp
end type
type st_3 from statictext within w_infodisp
end type
type cb_2 from commandbutton within w_infodisp
end type
type st_current from statictext within w_infodisp
end type
type st_complete from statictext within w_infodisp
end type
type st_count from statictext within w_infodisp
end type
type st_information from statictext within w_infodisp
end type
type pb_1 from picturebutton within w_infodisp
end type
type p_1 from picture within w_infodisp
end type
end forward
...
public subroutine of_start_ani ();//--------------------------- APPEON BEGIN ---------------------------
//$<comment> 10.12.2006 By: LeiWei
//$<reason> Fix a defect.
/*
...
//p_1.picturename = gs_sysrunpath + "\infodisp.gif"
p_1.picturename = "infodisp.gif"
IF appeongetclienttype() <> 'WEB' THEN p_1.picturename = Gs_Current_Directory + "\infodisp.gif"	
//-------End Modified --------------------------------
...
//$<reason> This window flicker when open it and set center.
//So modify w_infodisp.x = 10000, 
//if you use this window ,you must set it's center property to true. 
//then it will be displayed and not flicker again.
//---------------------------- APPEON END ----------------------------
