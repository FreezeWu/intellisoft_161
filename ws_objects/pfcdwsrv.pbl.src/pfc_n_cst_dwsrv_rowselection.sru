$PBExportHeader$pfc_n_cst_dwsrv_rowselection.sru
...
Boolean ib_ignorewin95 = False //Added By Ken.Guo 2010-11-02.
//---------End Added ------------------------------------------------------
...
public subroutine of_setignorewin95 (boolean ab_value)
end prototypes
...
//---------Begin Modified by (Appeon)Toney 06.04.2013 for V141 ISG-CLX--------
	...
	End If
    */
If Not ib_ignorewin95 Then //Add the if statement for ignore lb_waitforbuttonup & lb_takenoaction
	If ((ib_lbuttonpressed or ib_rbuttonpressed) And ab_cntrlpressed And ab_shiftpressed=False) Or &
		(idw_requestor.IsSelected(al_row) And ib_lbuttonpressed And &
		ab_cntrlpressed=False And ab_shiftpressed=False)  Then
		// Wait for the button up to process click.
...
public subroutine of_setignorewin95 (boolean ab_value);//////////////////////////////////////////////////////////////////////
// $<function>pfc_n_cst_dwsrv_rowselection.of_setignorewin95()
// $<arguments>
//		value	boolean	ab_value		
// $<returns> (none)
// $<description>
// $<description> Ignore win95. Default value is false
//////////////////////////////////////////////////////////////////////
// $<add> 2010-11-02 by Ken.Guo
//////////////////////////////////////////////////////////////////////
//$<Modify History>:
//(Appeon)Toney 06.04.2013 - V141 ISG-CLX
//////////////////////////////////////////////////////////////////////

ib_ignorewin95 = ab_value
end subroutine
