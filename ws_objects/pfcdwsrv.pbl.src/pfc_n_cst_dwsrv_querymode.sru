$PBExportHeader$pfc_n_cst_dwsrv_querymode.sru
...
li_value = GetFileOpenName (as_title, as_pathname, as_filename, as_ext, as_filter) 
gf_save_dir_path(as_pathname) //Added by Ken.Guo on 2009-03-10
//---------End Modfiied ------------------------------------------------------------------
