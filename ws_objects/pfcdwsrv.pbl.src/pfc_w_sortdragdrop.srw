...
public subroutine of_up_down_row (integer ai_current_row, integer ai_target_row)
end prototypes
...
FOR li_i = 1 to li_max 
	...
	IF IsNull(ls_colname) or LenA(Trim(ls_colname))=0 Then Continue
...
public subroutine of_up_down_row (integer ai_current_row, integer ai_target_row);//////////////////////////////////////////////////////////////////////
// $<function>pfc_w_sortdragdropof_up_down_row()
// $<arguments>
//		integer	ai_current_row		
//		integer	ai_target_row 		
// $<returns> (none)
// $<description>
// $<description>
//////////////////////////////////////////////////////////////////////
...
string ls_display_column,ls_sort_order,ls_columnname,ls_use_display
...
For i = 1 to ll_steps
	...
	ls_display_column = dw_sorted.object.displayname[ll_row]
	ls_sort_order = dw_sorted.object.sort_order[ll_row]
	ls_columnname = dw_sorted.object.columnname[ll_row]
	ls_use_display = dw_sorted.object.use_display[ll_row]
	
	dw_sorted.object.displayname[ll_row] = dw_sorted.object.displayname[ll_target_row]
	dw_sorted.object.sort_order[ll_row] = dw_sorted.object.sort_order[ll_target_row]
	dw_sorted.object.columnname[ll_row] = dw_sorted.object.columnname[ll_target_row]
	dw_sorted.object.use_display[ll_row] = dw_sorted.object.use_display[ll_target_row]
	
	dw_sorted.object.displayname[ll_target_row] = ls_display_column
	dw_sorted.object.sort_order[ll_target_row] = ls_sort_order
	dw_sorted.object.columnname[ll_target_row] = ls_columnname
	dw_sorted.object.use_display[ll_target_row] = ls_use_display

Next
dw_sorted.accepttext() 
dw_sorted.setrow(ll_target_row)
dw_sorted.scrolltorow(ll_target_row)
...
FOR li_i = 1 to li_orignumcols
	...
	IF li_found > 0 THEN
		...
		//--------------------------- APPEON BEGIN ---------------------------
		//$<modify> 2005-09-08 By: Liang QingShi
		//$<reason> 
		//		dw_sorted.SetItem ( li_i, "sort_order", inv_sortattrib.is_origorder[li_i] ) 
		dw_sorted.SetItem ( li_i, "sort_order", trim(inv_sortattrib.is_origorder[li_i]) ) 
...
IF dwo.name = "display_column" THEN 
	il_sortingrow = row
	this.DragIcon = "droparrow.ico"	// Add by Jack 06/21/2007
	// Start the drag.
	this.Drag ( Begin! ) 
END IF 
end event
...
//$<add> 06.21.2007 By: Jack
//$<reason> 
If classname(source) = 'dw_sorted' Then
	of_up_down_row(dw_sorted.getrow(),row)       
	Return
End If
//---------------------------- APPEON END ----------------------------
...
//$<reason> Showhelp() function is unsupported.
