...
type os_filedatetime from structure within pfc_n_cst_filesrvwin32
end type
type os_systemtime from structure within pfc_n_cst_filesrvwin32
end type
type os_securityattributes from structure within pfc_n_cst_filesrvwin32
end type
type os_finddata from structure within pfc_n_cst_filesrvwin32
end type
type os_fileopeninfo from structure within pfc_n_cst_filesrvwin32
end type
end forward
...
ls_string = Upper(LeftA(as_drive,1)) + ":\"
