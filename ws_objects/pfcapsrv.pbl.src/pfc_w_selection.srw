$PBExportHeader$pfc_w_selection.srw
...
// Set the dataobject
if Lower (LeftA (inv_selectionattrib.is_dataobject, 7)) = "release" then
	// If DW syntax was passed
	dw_1.Create (inv_selectionattrib.is_dataobject, ls_errbuffer)
else
	if Lower (LeftA (inv_selectionattrib.is_dataobject, 6)) = "select" then
