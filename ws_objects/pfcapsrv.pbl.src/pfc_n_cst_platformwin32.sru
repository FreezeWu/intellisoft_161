...
// Dialogs
function long PFC_PrintDlg (ulong hwnd, ref s_printdlgattrib printstruct) library "pbvm90.dll" alias for "PFC_PrintDlg;Ansi"
end prototypes
...
//	Returns:  			 0 = User Cancelled Print Dialog
//							 1 = Success
//							-2 = Max Pages less than To Pages
//							-3 = Min Pages greater than From Pages
//							-4 = To or From Pages less than 0 
//							-1 = Other error.
//	Description:  		Opens the print dialog
//////////////////////////////////////////////////////////////////////////////
//	Rev. History			Version
//							5.0		Initial version
//							8.0   Fixed problem with setting and getting number of copies.
//								   Moved external call to pbvm80.dll
//////////////////////////////////////////////////////////////////////////////
//	Copyright © 1996-2000 Sybase, Inc. and its subsidiaries.  All rights reserved.  Any distribution of the 
// PowerBuilder Foundation Classes (PFC) source code by other than Sybase, Inc. and its subsidiaries is prohibited.
//////////////////////////////////////////////////////////////////////////////
...
////$<reason> Invoke PB system funcation in web
//If appeongetclienttype() <> 'PB' Then
//	//RETURN PrintSetupPrinter ( )
//	RETURN PrintSetup( ) //02.01.2008 By Jervis
//End If
////---------------------------- APPEON END ----------------------------
//
//long ll_hwnd
...
//end if
//
//astr_printdlg.s_printer = Space ( 256 ) 
//
