$PBExportHeader$pfc_n_cst_platformaix.sru
$PBExportComments$PFC aix Cross Platform service
forward
global type pfc_n_cst_platformaix from n_cst_platform
end type
type os_memorystatus from structure within pfc_n_cst_platformaix
end type
type os_size from structure within pfc_n_cst_platformaix
end type
end forward
...
global pfc_n_cst_platformaix pfc_n_cst_platformaix
...
//////////////////////////////////////////////////////////////////////////////
//	Rev. History:	Version
//						7.0   Modified external library to libkernel42.so
//	   						   Modified external library to libuser42.so
//	 						   Modified external library to libgdi42.so
...
//////////////////////////////////////////////////////////////////////////////
// Sound
Function boolean sndPlaySoundA (string SoundName, ulong Flags) Library "libkernel43.so" alias for "sndPlaySoundA;Ansi"
//Function uint waveOutGetNumDevs () Library "WINMM.DLL"

// Get free memory
Subroutine GlobalMemoryStatus (ref os_memorystatus memorystatus ) Library "libkernel43.so" alias for "GlobalMemoryStatus;Ansi"

// Get module handle
Function ulong GetModuleHandleA(string modname) Library "libkernel43.so" alias for "GetModuleHandleA;Ansi"

// Window functions
Function ulong GetWindowTextA(ulong handle, ref string wintext, ulong length) Library "libuser43.so" alias for "GetWindowTextA;Ansi"
Function ulong GetWindowsDirectoryA (ref string dirtext, ulong textlen) library "libkernel43.so" alias for "GetWindowsDirectoryA;Ansi"
Function ulong GetSystemDirectoryA (ref string dirtext, ulong textlen) library "libkernel43.so" alias for "GetSystemDirectoryA;Ansi"
function ulong FindWindowA( ref string lpClassName, ref string lpWindowName) Library "libuser43.so" alias for "FindWindowA;Ansi"

// User/computer information
Function boolean GetUserNameA(ref string  lpBuffer, ref ulong nSize) library "libkernel43.so" alias for "GetUserNameA;Ansi"
function boolean GetComputerNameA(ref string  lpBuffer, ref ulong nSize) library "libkernel43.so" alias for "GetComputerNameA;Ansi"

// Get text size
Function boolean SystemParametersInfoA(uint wActon, uint wParam, REF int pvParam, uint fUpdateProfile) Library "libuser43.so"
Function ulong GetDC(ulong hWnd) Library "libgdi43.so"
Function long ReleaseDC(ulong hWnd, ulong hdcr) Library "libgdi43.so"
Function boolean GetTextExtentPoint32A(ulong hdcr, string lpString, long nCount, ref os_size size) Library "libgdi43.so" alias for "GetTextExtentPoint32A;Ansi"
Function ulong SelectObject(ulong hdc, ulong hWnd) Library "libgdi43.so"
end prototypes
...
//	Rev. History			Version
//							5.0.02   Initial version
// 							7.0	   Changed datatype of size from int to ulong
//////////////////////////////////////////////////////////////////////////////
//	Copyright © 1996-2000 Sybase, Inc. and its subsidiaries.  All rights reserved.  Any distribution of the 
// PowerBuilder Foundation Classes (PFC) source code by other than Sybase, Inc. and its subsidiaries is prohibited.
//////////////////////////////////////////////////////////////////////////////
...
If li_Return = 1 Then
	...
	If Not GetTextExtentpoint32A(lul_Hdc, as_Text, ll_Len, lstr_Size ) Then 
...
public function long of_PrintDlg (ref s_printdlgattrib astr_printdlg, window aw_obj);//////////////////////////////////////////////////////////////////////////////
//	Public Function:  	of_PrintDlg
//	Arguments:			astr_printdlg:  printdlg structure passed by ref
//							aw_obj:  window that is opening the print dialog window (no effect for Solaris)
//	Returns:  			1 = success, -1 = error or user cancelled from print dialog
...
on pfc_n_cst_platformaix.create
call super::create
end on

on pfc_n_cst_platformaix.destroy
call super::destroy
end on

event constructor;call super::constructor;//////////////////////////////////////////////////////////////////////////////
//	Object Name:		pfc_n_cst_platformaix
//	Description:  		Unix AIX platform object
//////////////////////////////////////////////////////////////////////////////
//	Rev. History			Version
//							6.0   Initial version
//////////////////////////////////////////////////////////////////////////////
