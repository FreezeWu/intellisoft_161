$PBExportHeader$pfc_n_cst_filesrvhpux.sru
$PBExportComments$PFC hpux File handler service
forward
global type pfc_n_cst_filesrvhpux from n_cst_filesrv
end type
type os_filedatetime from structure within pfc_n_cst_filesrvhpux
end type
type os_systemtime from structure within pfc_n_cst_filesrvhpux
end type
type os_securityattributes from structure within pfc_n_cst_filesrvhpux
end type
type os_finddata from structure within pfc_n_cst_filesrvhpux
end type
type os_fileopeninfo from structure within pfc_n_cst_filesrvhpux
end type
end forward
...
global pfc_n_cst_filesrvhpux pfc_n_cst_filesrvhpux

type prototypes
//////////////////////////////////////////////////////////////////////////////
//	Local Externs
//	Description:		HPUX Specific External Calls
//////////////////////////////////////////////////////////////////////////////
//	Rev. History:	Version
...
// HPUX calls
Function ulong GetDriveTypeA (string drive) library "libkernel43.sl" alias for "GetDriveTypeA;Ansi"
Function boolean CreateDirectoryA (ref string directoryname, ref os_securityattributes secattr) library "libkernel43.sl" alias for "CreateDirectoryA;Ansi"
Function boolean RemoveDirectoryA (ref string directoryname) library "libkernel43.sl" alias for "RemoveDirectoryA;Ansi"
Function ulong GetCurrentDirectoryA (ulong textlen, ref string dirtext) library "libkernel43.sl" alias for "GetCurrentDirectoryA;Ansi"
Function boolean SetCurrentDirectoryA (ref string directoryname ) library "libkernel43.sl" alias for "SetCurrentDirectoryA;Ansi"
Function ulong GetFileAttributesA (ref string filename) library "libkernel43.sl" alias for "GetFileAttributesA;Ansi"
Function boolean SetFileAttributesA (ref string filename, ulong attrib) library "libkernel43.sl" alias for "SetFileAttributesA;Ansi"
Function boolean MoveFileA (ref string oldfile, ref string newfile) library "libkernel43.sl" alias for "MoveFileA;Ansi"
Function long FindFirstFileA (ref string filename, ref os_finddata findfiledata) library "libkernel43.sl" alias for "FindFirstFileA;Ansi"
Function boolean FindNextFileA (long handle, ref os_finddata findfiledata) library "libkernel43.sl" alias for "FindNextFileA;Ansi"
Function boolean FindClose (long handle) library "libkernel43.sl"
Function boolean GetDiskFreeSpaceA (string drive, ref long sectpercluster, ref long bytespersect, ref long freeclusters, ref long totalclusters) library "libkernel43.sl" alias for "GetDiskFreeSpaceA;Ansi"
Function long GetLastError() library "libkernel43.sl"

// HPUX calls for file date and time
Function long OpenFile (ref string filename, ref os_fileopeninfo of_struct, ulong action) LIBRARY "libkernel43.sl" alias for "OpenFile;Ansi"
Function boolean CloseHandle (long file_hand) LIBRARY "libkernel43.sl"
Function boolean GetFileTime(long hFile, ref os_filedatetime  lpCreationTime, ref os_filedatetime  lpLastAccessTime, ref os_filedatetime  lpLastWriteTime  )  library "libkernel43.sl" alias for "GetFileTime;Ansi"
Function boolean FileTimeToSystemTime(ref os_filedatetime lpFileTime, ref os_systemtime lpSystemTime) library "libkernel43.sl" alias for "FileTimeToSystemTime;Ansi"
Function boolean FileTimeToLocalFileTime(ref os_filedatetime lpFileTime, ref os_filedatetime lpLocalFileTime) library "libkernel43.sl" alias for "FileTimeToLocalFileTime;Ansi"
Function boolean SetFileTime(long hFile, os_filedatetime  lpCreationTime, os_filedatetime  lpLastAccessTime, os_filedatetime  lpLastWriteTime  )  library "libkernel43.sl" alias for "SetFileTime;Ansi"
Function boolean SystemTimeToFileTime(os_systemtime lpSystemTime, ref os_filedatetime lpFileTime) library "libkernel43.sl" alias for "SystemTimeToFileTime;Ansi"
Function boolean LocalFileTimeToFileTime(ref os_filedatetime lpLocalFileTime, ref os_filedatetime lpFileTime) library "libkernel43.sl" alias for "LocalFileTimeToFileTime;Ansi"
end prototypes
...
lstr_SystemTime.ui_wyear = Long(LeftA(ls_Date, 4))
lstr_SystemTime.ui_WMonth = Long(MidA(ls_Date, 6, 2))
lstr_SystemTime.ui_WDay = Long(RightA(ls_Date, 2))

ls_Time = String(at_FileTime, "hh:mm:ss:fff")
lstr_SystemTime.ui_wHour = Long(LeftA(ls_Time, 2))
lstr_SystemTime.ui_wMinute = Long(MidA(ls_Time, 4, 2))
lstr_SystemTime.ui_wSecond = Long(MidA(ls_Time, 7, 2))
lstr_SystemTime.ui_wMilliseconds = Long(RightA(ls_Time, 3))
...
ls_drive = Upper(LeftA(as_drive,1)) + ":\"
...
on pfc_n_cst_filesrvhpux.create
call super::create
end on

on pfc_n_cst_filesrvhpux.destroy
call super::destroy
end on
