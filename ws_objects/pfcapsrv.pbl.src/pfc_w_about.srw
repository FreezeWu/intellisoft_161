...
If LenA(inv_aboutattrib.is_logo) > 0 Then
...
If LenA(inv_aboutattrib.is_application) > 0 Then
...
If LenA(inv_aboutattrib.is_version) > 0 Then
...
If LenA(inv_aboutattrib.is_copyright) > 0 Then
