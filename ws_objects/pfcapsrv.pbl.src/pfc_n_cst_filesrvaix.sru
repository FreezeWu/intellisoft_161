...
type os_filedatetime from structure within pfc_n_cst_filesrvaix
end type
type os_systemtime from structure within pfc_n_cst_filesrvaix
end type
type os_securityattributes from structure within pfc_n_cst_filesrvaix
end type
type os_finddata from structure within pfc_n_cst_filesrvaix
end type
type os_fileopeninfo from structure within pfc_n_cst_filesrvaix
end type
end forward
...
//////////////////////////////////////////////////////////////////////////////
//	Local Externs
//	Description:		AIX Specific External Calls
//////////////////////////////////////////////////////////////////////////////
//	Rev. History:	Version
//						7.0   Modified external library from libkernal40.a to libkernel42.so
...
// AIX calls
Function ulong GetDriveTypeA (string drive) library "libkernel43.so" alias for "GetDriveTypeA;Ansi"
Function boolean CreateDirectoryA (ref string directoryname, ref os_securityattributes secattr) library "libkernel43.so" alias for "CreateDirectoryA;Ansi"
Function boolean RemoveDirectoryA (ref string directoryname) library "libkernel43.so" alias for "RemoveDirectoryA;Ansi"
Function ulong GetCurrentDirectoryA (ulong textlen, ref string dirtext) library "libkernel43.so" alias for "GetCurrentDirectoryA;Ansi"
Function boolean SetCurrentDirectoryA (ref string directoryname ) library "libkernel43.so" alias for "SetCurrentDirectoryA;Ansi"
Function ulong GetFileAttributesA (ref string filename) library "libkernel43.so" alias for "GetFileAttributesA;Ansi"
Function boolean SetFileAttributesA (ref string filename, ulong attrib) library "libkernel43.so" alias for "SetFileAttributesA;Ansi"
Function boolean MoveFileA (ref string oldfile, ref string newfile) library "libkernel43.so" alias for "MoveFileA;Ansi"
Function long FindFirstFileA (ref string filename, ref os_finddata findfiledata) library "libkernel43.so" alias for "FindFirstFileA;Ansi"
Function boolean FindNextFileA (long handle, ref os_finddata findfiledata) library "libkernel43.so" alias for "FindNextFileA;Ansi"
Function boolean FindClose (long handle) library "libkernel43.so"
Function boolean GetDiskFreeSpaceA (string drive, ref long sectpercluster, ref long bytespersect, ref long freeclusters, ref long totalclusters) library "libkernel43.so" alias for "GetDiskFreeSpaceA;Ansi"
Function long GetLastError() library "libkernel43.so"

// AIX calls for file date and time
Function long OpenFile (ref string filename, ref os_fileopeninfo of_struct, ulong action) LIBRARY "libkernel43.so" alias for "OpenFile;Ansi"
Function boolean CloseHandle (long file_hand) LIBRARY "libkernel43.so"
Function boolean GetFileTime(long hFile, ref os_filedatetime  lpCreationTime, ref os_filedatetime  lpLastAccessTime, ref os_filedatetime  lpLastWriteTime  )  library "libkernel43.so" alias for "GetFileTime;Ansi"
Function boolean FileTimeToSystemTime(ref os_filedatetime lpFileTime, ref os_systemtime lpSystemTime) library "libkernel43.so" alias for "FileTimeToSystemTime;Ansi"
Function boolean FileTimeToLocalFileTime(ref os_filedatetime lpFileTime, ref os_filedatetime lpLocalFileTime) library "libkernel43.so" alias for "FileTimeToLocalFileTime;Ansi"
Function boolean SetFileTime(long hFile, os_filedatetime  lpCreationTime, os_filedatetime  lpLastAccessTime, os_filedatetime  lpLastWriteTime  )  library "libkernel43.so" alias for "SetFileTime;Ansi"
Function boolean SystemTimeToFileTime(os_systemtime lpSystemTime, ref os_filedatetime lpFileTime) library "libkernel43.so" alias for "SystemTimeToFileTime;Ansi"
Function boolean LocalFileTimeToFileTime(ref os_filedatetime lpLocalFileTime, ref os_filedatetime lpFileTime) library "libkernel43.so" alias for "LocalFileTimeToFileTime;Ansi"
end prototypes
