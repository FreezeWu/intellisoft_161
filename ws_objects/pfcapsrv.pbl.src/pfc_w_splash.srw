$PBExportHeader$pfc_w_splash.srw
...
If LenA(inv_splashattrib.is_logo) > 0 Then
...
// Copyright
If LenA(inv_splashattrib.is_copyright) > 0 Then
...
If LenA(inv_splashattrib.is_application) > 0 Then
...
// Application version
If LenA(inv_splashattrib.is_version) > 0 Then
