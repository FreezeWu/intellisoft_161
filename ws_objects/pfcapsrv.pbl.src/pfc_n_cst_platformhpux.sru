...
type os_memorystatus from structure within pfc_n_cst_platformhpux
end type
type os_size from structure within pfc_n_cst_platformhpux
end type
end forward
...
//////////////////////////////////////////////////////////////////////////////
//	Rev. History:	Version
//						7.0   Modified external library to libkernel42.sl
//	   						   Modified external library to libuser42.sl
//	 						   Modified external library to libgdi42.sl
...
//////////////////////////////////////////////////////////////////////////////
// Sound
Function boolean sndPlaySoundA (string SoundName, ulong Flags) Library "libkernel43.sl" alias for "sndPlaySoundA;Ansi"
//Function uint waveOutGetNumDevs () Library "WINMM.DLL"

// Get free memory
Subroutine GlobalMemoryStatus (ref os_memorystatus memorystatus ) Library "libkernel43.sl" alias for "GlobalMemoryStatus;Ansi"

// Get module handle
Function ulong GetModuleHandleA(string modname) Library "libkernel43.sl" alias for "GetModuleHandleA;Ansi"

// Window functions
Function ulong GetWindowTextA(ulong handle, ref string wintext, ulong length) Library "libuser43.sl" alias for "GetWindowTextA;Ansi"
Function ulong GetWindowsDirectoryA (ref string dirtext, ulong textlen) library "libkernel43.sl" alias for "GetWindowsDirectoryA;Ansi"
Function ulong GetSystemDirectoryA (ref string dirtext, ulong textlen) library "libkernel43.sl" alias for "GetSystemDirectoryA;Ansi"
function ulong FindWindowA( ref string lpClassName, ref string lpWindowName) Library "libuser43.sl" alias for "FindWindowA;Ansi"

// User/computer information
Function boolean GetUserNameA(ref string  lpBuffer, ref ulong nSize) library "libkernel43.sl" alias for "GetUserNameA;Ansi"
function boolean GetComputerNameA(ref string  lpBuffer, ref ulong nSize) library "libkernel43.sl" alias for "GetComputerNameA;Ansi"

// Get text size
Function boolean SystemParametersInfoA(uint wActon, uint wParam, REF int pvParam, uint fUpdateProfile) Library "libuser43.sl"
Function ulong GetDC(ulong hWnd) Library "libgdi43.sl"
Function long ReleaseDC(ulong hWnd, ulong hdcr) Library "libgdi43.sl"
Function boolean GetTextExtentPoint32A(ulong hdcr, string lpString, long nCount, ref os_size size) Library "libgdi43.sl" alias for "GetTextExtentPoint32A;Ansi"
Function ulong SelectObject(ulong hdc, ulong hWnd) Library "libgdi43.sl"
end prototypes
...
//	Object Name:		pfc_n_cst_platformhpux
//	Description:  		Unix HPUX platform object
//////////////////////////////////////////////////////////////////////////////
//	Rev. History			Version
//							6.0   Initial version
//////////////////////////////////////////////////////////////////////////////
