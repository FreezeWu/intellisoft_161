$PBExportHeader$w_process_setup_mockup.srw
forward
global type w_process_setup_mockup from w_sheet
end type
type cb_copy_step from commandbutton within w_process_setup_mockup
end type
type cb_1 from commandbutton within w_process_setup_mockup
end type
type dw_step_detail from u_dw within w_process_setup_mockup
end type
type dw_step_browse from u_dw within w_process_setup_mockup
end type
type dw_alert_detail from u_dw within w_process_setup_mockup
end type
type dw_alert_browse from u_dw within w_process_setup_mockup
end type
type cb_add_temp from commandbutton within w_process_setup_mockup
end type
type cb_del_alert from commandbutton within w_process_setup_mockup
end type
type cb_save from commandbutton within w_process_setup_mockup
end type
type cb_close from commandbutton within w_process_setup_mockup
end type
type cb_copy_alert from commandbutton within w_process_setup_mockup
end type
type cb_add_step from commandbutton within w_process_setup_mockup
end type
type cb_del_step from commandbutton within w_process_setup_mockup
end type
type gb_2 from groupbox within w_process_setup_mockup
end type
type gb_1 from groupbox within w_process_setup_mockup
end type
end forward
...
global w_process_setup_mockup w_process_setup_mockup
...
for i = 1 to dw_alert_detail.RowCount()
	...
	if dw_alert_detail.object.alert_type[i] <> 30 then
...
on w_process_setup_mockup.create
int iCurrent
call super::create
...
this.Control[iCurrent+1]=this.cb_copy_step
this.Control[iCurrent+2]=this.cb_1
this.Control[iCurrent+3]=this.dw_step_detail
this.Control[iCurrent+4]=this.dw_step_browse
this.Control[iCurrent+5]=this.dw_alert_detail
this.Control[iCurrent+6]=this.dw_alert_browse
this.Control[iCurrent+7]=this.cb_add_temp
this.Control[iCurrent+8]=this.cb_del_alert
this.Control[iCurrent+9]=this.cb_save
this.Control[iCurrent+10]=this.cb_close
this.Control[iCurrent+11]=this.cb_copy_alert
this.Control[iCurrent+12]=this.cb_add_step
this.Control[iCurrent+13]=this.cb_del_step
this.Control[iCurrent+14]=this.gb_2
this.Control[iCurrent+15]=this.gb_1
end on

on w_process_setup_mockup.destroy
call super::destroy
...
event buttonclicked;call super::buttonclicked;if dwo.name = "b_select" then	
	of_SelectEmail()
