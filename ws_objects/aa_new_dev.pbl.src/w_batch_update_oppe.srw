$PBExportHeader$w_batch_update_oppe.srw
forward
global type w_batch_update_oppe from window
end type
type st_1 from statictext within w_batch_update_oppe
end type
type dw_1 from u_dw within w_batch_update_oppe
end type
type rb_r from radiobutton within w_batch_update_oppe
end type
type rb_a from radiobutton within w_batch_update_oppe
end type
type rb_b from radiobutton within w_batch_update_oppe
end type
type cb_2 from commandbutton within w_batch_update_oppe
end type
type cb_up from commandbutton within w_batch_update_oppe
end type
type em_to from editmask within w_batch_update_oppe
end type
type st_1a from statictext within w_batch_update_oppe
end type
type st_2a from statictext within w_batch_update_oppe
end type
type em_from from editmask within w_batch_update_oppe
end type
type dw_pracs from datawindow within w_batch_update_oppe
end type
type dw_facility from datawindow within w_batch_update_oppe
end type
type gb_filt from groupbox within w_batch_update_oppe
end type
type gb_f from groupbox within w_batch_update_oppe
end type
type gb_1 from groupbox within w_batch_update_oppe
end type
type ddlb_1 from dropdownlistbox within w_batch_update_oppe
end type
end forward
...
global w_batch_update_oppe w_batch_update_oppe
...
on w_batch_update_oppe.destroy
destroy(this.st_1)
destroy(this.dw_1)
destroy(this.rb_r)
destroy(this.rb_a)
