...
//$<reason> The settoolbar method of window object(control) is unsupported.
...
If IsValid (lw_frame) Then
	...
	If lnv_menu.of_GetAllToolbarIndex (lw_frame.MenuID, li_framearrayindex) > 0 Then
		...
		For li_cnt = 1 To li_arraysize
			//--------------------------- APPEON BEGIN ---------------------------
			//$<comment> 2005-09-02 By: Liang QingShi
			//$<reason> The GetToolbar method of window object(control) is unsupported.
