$PBExportHeader$pfc_n_cst_resize.sru
...
Boolean		ib_CloseResize  //added by gavins 20121224  //(Appeon)Harry 01.21.2014 - V142 ISG-CLX
end variables
...
public function integer of_unregisterall ()
public subroutine of_setcloseresize (boolean ab_resize)
end prototypes
...
//
//////////////////////////////////////////////////////////////////////////////
If ib_CloseResize Then Return 1//added by gavins 20121224  //(Appeon)Harry 01.21.2014 - V142 ISG-CLX
...
//Add By Jervis 11-06-2008:u_calendar don't need resize
if awo_control.classname() = "u_calendar" then return -1
...
li_registered_slot = 0
For li_cnt = 1 to li_upperbound
	//of_unregister(inv_registered[li_cnt].wo_control)
//	If inv_registered[li_cnt].wo_control = awo_control Then
//		li_registered_slot = li_cnt
//		exit
//	End If
	//li_upperbound = UpperBound (inv_registered[])
	SetNull(inv_registered[li_cnt].wo_control)
	inv_registered[li_cnt].s_typeof = ''
	inv_registered[li_cnt].b_movex = False
	inv_registered[li_cnt].i_movex = 0
	inv_registered[li_cnt].b_movey = False
	inv_registered[li_cnt].i_movey = 0
	inv_registered[li_cnt].b_scalewidth = False
	inv_registered[li_cnt].i_scalewidth = 0
	inv_registered[li_cnt].b_scaleheight = False
	inv_registered[li_cnt].i_scaleheight = 0
Next
...
public subroutine of_setcloseresize (boolean ab_resize);// (Appeon)Harry 01.21.2014 - V142 ISG-CLX Copy from CLX12.0
ib_CloseResize = ab_resize //
end subroutine
