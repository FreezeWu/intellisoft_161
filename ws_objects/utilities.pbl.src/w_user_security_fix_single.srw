$PBExportHeader$w_user_security_fix_single.srw
forward
global type w_user_security_fix_single from window
end type
type cb_2 from commandbutton within w_user_security_fix_single
end type
type dw_all_rights from datawindow within w_user_security_fix_single
end type
type cb_rights from commandbutton within w_user_security_fix_single
end type
type dw_rights from datawindow within w_user_security_fix_single
end type
type dw_act from datawindow within w_user_security_fix_single
end type
type dw_role from datawindow within w_user_security_fix_single
end type
type dw_2 from datawindow within w_user_security_fix_single
end type
type cb_view from commandbutton within w_user_security_fix_single
end type
type dw_view from datawindow within w_user_security_fix_single
end type
type st_3 from statictext within w_user_security_fix_single
end type
type st_1 from statictext within w_user_security_fix_single
end type
type st_2 from statictext within w_user_security_fix_single
end type
type cb_dupe from commandbutton within w_user_security_fix_single
end type
type dw_3 from datawindow within w_user_security_fix_single
end type
type dw_1 from datawindow within w_user_security_fix_single
end type
type cb_3 from commandbutton within w_user_security_fix_single
end type
type cb_1 from commandbutton within w_user_security_fix_single
end type
type dw_dupe from datawindow within w_user_security_fix_single
end type
end forward
...
string title = "Check user security"
...
global w_user_security_fix_single w_user_security_fix_single
...
on w_user_security_fix_single.create
...
on w_user_security_fix_single.destroy
destroy(this.cb_2)
...
r = dw_3.setfilter("user_id = '" + ls_user + "'" )
if r < 0 then messagebox("","User Filter Failed")
dw_3.filter()

this.title = "Check Security for: " + ls_user
