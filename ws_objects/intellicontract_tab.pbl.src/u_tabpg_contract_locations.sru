$PBExportHeader$u_tabpg_contract_locations.sru
$PBExportComments$[intellicontract_tab]  The contract locations Tab Page
forward
global type u_tabpg_contract_locations from u_tabpg_contract_master
end type
type dw_main from u_dw_contract within u_tabpg_contract_locations
end type
type dw_detail from u_dw_contract within u_tabpg_contract_locations
end type
type cb_1 from commandbutton within u_tabpg_contract_locations
end type
type cb_3 from commandbutton within u_tabpg_contract_locations
end type
type cb_4 from commandbutton within u_tabpg_contract_locations
end type
type cb_5 from commandbutton within u_tabpg_contract_locations
end type
type gb_4 from u_gb within u_tabpg_contract_locations
end type
type dw_doctors from u_dw_contract within u_tabpg_contract_locations
end type
type dw_spec from u_dw_contract within u_tabpg_contract_locations
end type
end forward
...
global u_tabpg_contract_locations u_tabpg_contract_locations
...
on u_tabpg_contract_locations.create
int iCurrent
call super::create
...
this.Control[iCurrent+8]=this.dw_doctors
this.Control[iCurrent+9]=this.dw_spec
end on

on u_tabpg_contract_locations.destroy
call super::destroy
...
type st_1 from u_tabpg_contract_master`st_1 within u_tabpg_contract_locations
integer x = 18
integer y = 2052
integer width = 3694
integer height = 92
...
boolean bringtotop = true
boolean titlebar = true
string title = "Associated Physicians for Selected Facility"
boolean minbox = true
boolean maxbox = true
boolean hscrollbar = true
boolean ib_rmbmenu = false
