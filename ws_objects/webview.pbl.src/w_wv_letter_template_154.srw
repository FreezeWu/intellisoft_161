$PBExportHeader$w_wv_letter_template_154.srw
forward
global type w_wv_letter_template_154 from w_sheet
end type
type cb_ds from commandbutton within w_wv_letter_template_154
end type
type cb_close from commandbutton within w_wv_letter_template_154
end type
type cb_save from commandbutton within w_wv_letter_template_154
end type
type dw_wv_letter_template from u_dw within w_wv_letter_template_154
end type
end forward
...
global w_wv_letter_template_154 w_wv_letter_template_154
...
on w_wv_letter_template_154.create
int iCurrent
call super::create
...
on w_wv_letter_template_154.destroy
call super::destroy
destroy(this.cb_ds)
...
integer height = 356
integer taborder = 10
string dataobject = "d_wv_letter_template154"
end type
