$PBExportHeader$w_wv_required_template.srw
$PBExportComments$WebView required document template
forward
global type w_wv_required_template from w_response
end type
type cb_document_type_setup from commandbutton within w_wv_required_template
end type
type cb_close from commandbutton within w_wv_required_template
end type
type cb_save from commandbutton within w_wv_required_template
end type
type cb_selectall from commandbutton within w_wv_required_template
end type
type dw_images from u_dw within w_wv_required_template
end type
type dw_select from datawindow within w_wv_required_template
end type
type cb_delete from commandbutton within w_wv_required_template
end type
type cb_copy from commandbutton within w_wv_required_template
end type
type cb_new from commandbutton within w_wv_required_template
end type
type gb_1 from groupbox within w_wv_required_template
end type
end forward
...
global w_wv_required_template w_wv_required_template
...
on w_wv_required_template.create
int iCurrent
call super::create
...
this.Control[iCurrent+1]=this.cb_document_type_setup
this.Control[iCurrent+2]=this.cb_close
this.Control[iCurrent+3]=this.cb_save
this.Control[iCurrent+4]=this.cb_selectall
this.Control[iCurrent+5]=this.dw_images
...
on w_wv_required_template.destroy
call super::destroy
...
event open;call super::open;//Start Code Change ----11.16.2016 #V153 maha - added
...
event clicked;open(w_image_type_painter)  //Start Code Change ----11.16.2016 #V153 maha - added button
