$PBExportHeader$w_copy_contract.srw
$PBExportComments$Create by Jack 05/30/2007
forward
global type w_copy_contract from w_response
end type
type cbx_18 from checkbox within w_copy_contract
end type
type cb_default from commandbutton within w_copy_contract
end type
type cbx_15 from checkbox within w_copy_contract
end type
type cbx_16 from checkbox within w_copy_contract
end type
type cbx_17 from checkbox within w_copy_contract
end type
type cb_2 from commandbutton within w_copy_contract
end type
type cb_cancel from commandbutton within w_copy_contract
end type
type cb_ok from commandbutton within w_copy_contract
end type
type cbx_13 from checkbox within w_copy_contract
end type
type cbx_12 from checkbox within w_copy_contract
end type
type cbx_11 from checkbox within w_copy_contract
end type
type cbx_10 from checkbox within w_copy_contract
end type
type cbx_9 from checkbox within w_copy_contract
end type
type cbx_8 from checkbox within w_copy_contract
end type
type cbx_7 from checkbox within w_copy_contract
end type
type cbx_6 from checkbox within w_copy_contract
end type
type cbx_5 from checkbox within w_copy_contract
end type
type cbx_4 from checkbox within w_copy_contract
end type
type cbx_3 from checkbox within w_copy_contract
end type
type cbx_2 from checkbox within w_copy_contract
end type
type cbx_1 from checkbox within w_copy_contract
end type
type st_1 from statictext within w_copy_contract
end type
type gb_1 from groupbox within w_copy_contract
end type
type cbx_14 from checkbox within w_copy_contract
end type
type gb_2 from groupbox within w_copy_contract
end type
end forward
...
global w_copy_contract w_copy_contract
...
If this.text = '&Select All' Then
	...
	if cbx_18.enabled = true then cbx_18.checked = true//Added by Appeon long.zhang 04.24.2014 (v14.2 Provider-Contract direct linking)
...
Else
	...
	cbx_18.checked = false//Added by Appeon long.zhang 04.24.2014 (v14.2 Provider-Contract direct linking)
