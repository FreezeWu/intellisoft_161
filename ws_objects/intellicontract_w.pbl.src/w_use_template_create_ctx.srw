$PBExportHeader$w_use_template_create_ctx.srw
forward
global type w_use_template_create_ctx from w_response
end type
type cb_delete from commandbutton within w_use_template_create_ctx
end type
type cb_2 from commandbutton within w_use_template_create_ctx
end type
type tab_1 from tab within w_use_template_create_ctx
end type
...
type cb_1 from commandbutton within w_use_template_create_ctx
end type
type cb_cancel from commandbutton within w_use_template_create_ctx
end type
type cb_ok from commandbutton within w_use_template_create_ctx
end type
type st_1 from statictext within w_use_template_create_ctx
end type
end forward
...
integer width = 2478
integer height = 1508
string title = "Use Template to Create Contract"
...
global w_use_template_create_ctx w_use_template_create_ctx
...
on w_use_template_create_ctx.create
int iCurrent
call super::create
...
on w_use_template_create_ctx.destroy
call super::destroy
...
if gb_contract_version then 
	tab_1.tabpage_2.dw_detail.modify("ib_linked_provider.visible = '0' gb_1.height='402'")
else
	tab_1.tabpage_2.dw_detail.modify("ib_linked_provider.visible = '1'")
end if
end event
...
If ll_row <= 0 then return -1 //(Appeon)Harry 07.26.2013
...
// Delete template data by lnv_contract.of_delete_ctx_detail(ll_ctx_id)
//	If tab_1.tabpage_1.dw_browse.update() = 1 Then
//		Commit;
//	Else
//		Rollback;
//		tab_1.tabpage_1.dw_browse.Retrieve()
