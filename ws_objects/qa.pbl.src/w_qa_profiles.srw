$PBExportHeader$w_qa_profiles.srw
forward
global type w_qa_profiles from window
end type
type cb_delprof from commandbutton within w_qa_profiles
end type
type cb_addprof from commandbutton within w_qa_profiles
end type
type p_1 from picture within w_qa_profiles
end type
type cb_delete_measurement from u_cb within w_qa_profiles
end type
type cb_create_measurement from u_cb within w_qa_profiles
end type
type cb_copy from u_cb within w_qa_profiles
end type
type cb_1 from u_cb within w_qa_profiles
end type
type cb_save from u_cb within w_qa_profiles
end type
type cb_preview from u_cb within w_qa_profiles
end type
type cb_close from u_cb within w_qa_profiles
end type
type dw_category from u_dw within w_qa_profiles
end type
type dw_measurements from u_dw within w_qa_profiles
end type
type dw_profile from u_dw within w_qa_profiles
end type
end forward
...
global w_qa_profiles w_qa_profiles
...
this.Control[]={this.cb_delprof,&
this.cb_addprof,&
this.p_1,&
this.cb_delete_measurement,&
this.cb_create_measurement,&
this.cb_copy,&
this.cb_1,&
this.cb_save,&
this.cb_preview,&
this.cb_close,&
this.dw_category,&
this.dw_measurements,&
this.dw_profile}
end on

on w_qa_profiles.destroy
...
event open;dw_profile.retrieve()
end event
