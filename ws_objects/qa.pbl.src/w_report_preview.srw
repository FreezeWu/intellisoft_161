...
forward
global type w_report_preview from w_response
end type
type cb_5 from uo_cb_output within w_report_preview
end type
type cb_4 from commandbutton within w_report_preview
end type
type cb_2 from u_cb within w_report_preview
end type
type dw_1 from u_dw within w_report_preview
end type
end forward
...
integer height = 1684
integer taborder = 10
string dataobject = "d_qa_profile_preview"
