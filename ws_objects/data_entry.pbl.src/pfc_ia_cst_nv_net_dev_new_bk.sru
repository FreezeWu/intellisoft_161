$PBExportHeader$pfc_ia_cst_nv_net_dev_new_bk.sru
forward
global type pfc_ia_cst_nv_net_dev_new_bk from pfc_cst_nv_net_dev_prac_folder
end type
...
type gb_filter_1 from groupbox within pfc_ia_cst_nv_net_dev_new_bk
end type
type cb_ma from commandbutton within pfc_ia_cst_nv_net_dev_new_bk
end type
type dw_payors from u_dw within pfc_ia_cst_nv_net_dev_new_bk
end type
type st_as_msg from statictext within pfc_ia_cst_nv_net_dev_new_bk
end type
type dw_facility_add from u_dw within pfc_ia_cst_nv_net_dev_new_bk
end type
type cb_batch from commandbutton within pfc_ia_cst_nv_net_dev_new_bk
end type
type p_1 from picture within pfc_ia_cst_nv_net_dev_new_bk
end type
type cbx_compl from checkbox within pfc_ia_cst_nv_net_dev_new_bk
end type
type cb_change from commandbutton within pfc_ia_cst_nv_net_dev_new_bk
end type
type st_filter from statictext within pfc_ia_cst_nv_net_dev_new_bk
end type
type dw_qf from datawindow within pfc_ia_cst_nv_net_dev_new_bk
end type
type st_group_by from statictext within pfc_ia_cst_nv_net_dev_new_bk
end type
type ddlb_group_by from dropdownlistbox within pfc_ia_cst_nv_net_dev_new_bk
end type
type st_zoom from statictext within pfc_ia_cst_nv_net_dev_new_bk
end type
type ddlb_zoom from dropdownlistbox within pfc_ia_cst_nv_net_dev_new_bk
end type
type cb_3 from commandbutton within pfc_ia_cst_nv_net_dev_new_bk
end type
end forward
...
global pfc_ia_cst_nv_net_dev_new_bk pfc_ia_cst_nv_net_dev_new_bk
...
on pfc_ia_cst_nv_net_dev_new_bk.create
int iCurrent
call super::create
...
on pfc_ia_cst_nv_net_dev_new_bk.destroy
call super::destroy
...
type tab_1 from pfc_cst_nv_net_dev_prac_folder`tab_1 within pfc_ia_cst_nv_net_dev_new_bk
integer x = 992
integer y = 232
integer width = 3511
integer height = 1760
...
type dw_orgs_facilities from pfc_cst_nv_net_dev_prac_folder`dw_orgs_facilities within pfc_ia_cst_nv_net_dev_new_bk
