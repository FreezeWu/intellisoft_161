$PBExportHeader$pfc_u_tabpg_dwproperty_srvmultitable.sru
...
// Validate arguments.
If LenA(Trim(as_table)) = 0 Then li_rc = -1
...
If LenA(Trim(as_table)) = 0 Then Return -1
...
// Validate arguments.
If LenA(Trim(as_option)) = 0 Then Return -1
