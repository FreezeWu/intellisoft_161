$PBExportHeader$pfc_u_tabpg_dwproperty_status.sru
...
If ll_currow > 0 And LenA(ls_colname) > 0 Then
	// -- Set the stat fields. --
	// Row.
...
If LenA(Trim(inv_attrib.is_dataobjectstatus)) > 0 Then
