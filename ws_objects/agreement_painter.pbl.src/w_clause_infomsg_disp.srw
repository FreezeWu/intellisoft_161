$PBExportHeader$w_clause_infomsg_disp.srw
forward
global type w_clause_infomsg_disp from w_response
end type
type pb_last from picturebutton within w_clause_infomsg_disp
end type
type pb_next from picturebutton within w_clause_infomsg_disp
end type
type pb_prior from picturebutton within w_clause_infomsg_disp
end type
type pb_first from picturebutton within w_clause_infomsg_disp
end type
type st_1 from statictext within w_clause_infomsg_disp
end type
type dw_1 from u_dw within w_clause_infomsg_disp
end type
type cb_1 from commandbutton within w_clause_infomsg_disp
end type
type rte_1 from richtextedit within w_clause_infomsg_disp
end type
end forward
...
global w_clause_infomsg_disp w_clause_infomsg_disp
...
on w_clause_infomsg_disp.create
int iCurrent
call super::create
...
on w_clause_infomsg_disp.destroy
call super::destroy
...
integer height = 1472
integer taborder = 10
string dataobject = "d_agreement_template_clause_infomsg"
