$PBExportHeader$w_clause_autonum_example.srw
forward
global type w_clause_autonum_example from window
end type
type mle_1 from multilineedit within w_clause_autonum_example
end type
type cb_ok from commandbutton within w_clause_autonum_example
end type
end forward
...
global w_clause_autonum_example w_clause_autonum_example

on w_clause_autonum_example.create
...
on w_clause_autonum_example.destroy
destroy(this.mle_1)
destroy(this.cb_ok)
end on
...
"                                                                  SCHEDULE @@    " + '~r~n' + &
"                                                                        TO       " + '~r~n' + &
"                                       IntelliSoft LICENSE AND MAINTENANCE AGREEMENT  " + '~r~n' + &
"                                                " + '~r~n' + &
"                                 DESCRIPTION OF MINIMUM HARDWARE, OPERATING SYSTEM SOFTWARE  " + '~r~n' + &
"                                          AND OTHER HARDWARE/SOFTWARE REQUIREMENT  " + '~r~n' + &
"                                                " + '~r~n' + &
"#.0	IntelliCred is a Windows product designed to provide the following capabilities: " + '~r~n' + &
"   #.#	A database of relevant personal and comprehensive credentialing data on individual practitioners and other providers. " + '~r~n' + &
"               ......                                       " + '~r~n' + & 
"#.0	IntelliCred for Windows is Y2K compliant and uses Y2K compliant software subsystems. " + '~r~n' + &
"               ......                                        " 
