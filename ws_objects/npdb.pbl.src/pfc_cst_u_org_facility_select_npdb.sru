$PBExportHeader$pfc_cst_u_org_facility_select_npdb.sru
forward
global type pfc_cst_u_org_facility_select_npdb from datawindow
end type
end forward
...
global pfc_cst_u_org_facility_select_npdb pfc_cst_u_org_facility_select_npdb
...
on pfc_cst_u_org_facility_select_npdb.create
end on

on pfc_cst_u_org_facility_select_npdb.destroy
end on
