$PBExportHeader$w_workflow.srw
forward
global type w_workflow from window
end type
type st_10 from statictext within w_workflow
end type
type st_9 from statictext within w_workflow
end type
type cbx_2 from checkbox within w_workflow
end type
type cbx_4 from checkbox within w_workflow
end type
type tab_1 from tab within w_workflow
end type
...
type sle_2 from singlelineedit within w_workflow
end type
type st_5 from statictext within w_workflow
end type
type cbx_1 from checkbox within w_workflow
end type
type ddlb_2 from dropdownlistbox within w_workflow
end type
type st_4 from statictext within w_workflow
end type
type st_2 from statictext within w_workflow
end type
type sle_1 from singlelineedit within w_workflow
end type
type st_1 from statictext within w_workflow
end type
type ddlb_1 from dropdownlistbox within w_workflow
end type
end forward
...
global w_workflow w_workflow

on w_workflow.create
...
boolean vscrollbar = true
string item[] = {"Modification to an existing Action Item","Data Entry Complete button clicked","Application Audit Complete button clicked","Practitioner Credentialing Data being modified","Practitioner affiliated with new Facility","Pracitioner affiliated with a new Payor/Hospital","A specific date","A specific date based on a field within IntelliApp/IntelliCred","New document scanned into practitioner folder","New Practitioner entered in the system","All Verifications Completed","Practitioner Sent to committee for review","Committee Results entered","Custom Query Only","Credentialing Data Record Added","Credentialing Data Record Deleted","Credentialing Data Record Updated","Scheduled Event","At startup of system","At exit of system"}
borderstyle borderstyle = stylelowered!
end type
...
long backcolor = 33551856
boolean enabled = false
string text = "What will trigger this workflow action to happen?"
boolean focusrectangle = false
end type
...
long textcolor = 33554432
boolean vscrollbar = true
string item[] = {"Create NEW action Item(s)","MODIFY existing action item(s)","Create  NEW action item(s) and MODIFY existing action item(s)","Run an external application","Run an IntelliExport Query","Custom SQL (Insert / Update )","Generate a Report","Send an email","Import Data"}
borderstyle borderstyle = stylelowered!
end type
