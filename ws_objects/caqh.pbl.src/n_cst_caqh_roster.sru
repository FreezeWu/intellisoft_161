$PBExportHeader$n_cst_caqh_roster.sru
forward
global type n_cst_caqh_roster from nonvisualobject
end type
end forward

global type n_cst_caqh_roster from nonvisualobject
end type
global n_cst_caqh_roster n_cst_caqh_roster
...
on n_cst_caqh_roster.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_cst_caqh_roster.destroy
