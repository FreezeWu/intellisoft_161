$PBExportHeader$w_caqh_xml_read_maha.srw
$PBExportComments$modified code for the practiceaddress section and address links
forward
global type w_caqh_xml_read_maha from w_popup
end type
type cb_about from commandbutton within w_caqh_xml_read_maha
end type
type cb_ac from commandbutton within w_caqh_xml_read_maha
end type
type dw_log_items from datawindow within w_caqh_xml_read_maha
end type
type cbx_ac from checkbox within w_caqh_xml_read_maha
end type
type pb_1 from picturebutton within w_caqh_xml_read_maha
end type
type cbx_dir from checkbox within w_caqh_xml_read_maha
end type
type dw_app_audit from datawindow within w_caqh_xml_read_maha
end type
type cbx_pid from checkbox within w_caqh_xml_read_maha
end type
type cbx_title from checkbox within w_caqh_xml_read_maha
end type
type cb_3 from commandbutton within w_caqh_xml_read_maha
end type
type cb_all from commandbutton within w_caqh_xml_read_maha
end type
type dw_verifs from datawindow within w_caqh_xml_read_maha
end type
type dw_otherids from datawindow within w_caqh_xml_read_maha
end type
type dw_verifsxxxx from datawindow within w_caqh_xml_read_maha
end type
type dw_audit_trail from datawindow within w_caqh_xml_read_maha
end type
type dw_spec_link from datawindow within w_caqh_xml_read_maha
end type
type dw_hosp_link from datawindow within w_caqh_xml_read_maha
end type
type dw_addr_link from datawindow within w_caqh_xml_read_maha
end type
type dw_appointment from datawindow within w_caqh_xml_read_maha
end type
type dw_log from datawindow within w_caqh_xml_read_maha
end type
type cb_4 from commandbutton within w_caqh_xml_read_maha
end type
type lb_1 from listbox within w_caqh_xml_read_maha
end type
type dw_facility_default from u_dw within w_caqh_xml_read_maha
end type
type dw_code_lu from datawindow within w_caqh_xml_read_maha
end type
type dw_address_lu from datawindow within w_caqh_xml_read_maha
end type
type dw_ecfmg from datawindow within w_caqh_xml_read_maha
end type
type dw_map_fields from datawindow within w_caqh_xml_read_maha
end type
type dw_dea from datawindow within w_caqh_xml_read_maha
end type
type dw_claims from datawindow within w_caqh_xml_read_maha
end type
type dw_workgap from datawindow within w_caqh_xml_read_maha
end type
type dw_hospital from datawindow within w_caqh_xml_read_maha
end type
type dw_attest from datawindow within w_caqh_xml_read_maha
end type
type dw_specialty from datawindow within w_caqh_xml_read_maha
end type
type dw_language from datawindow within w_caqh_xml_read_maha
end type
type dw_license from datawindow within w_caqh_xml_read_maha
end type
type cb_run from commandbutton within w_caqh_xml_read_maha
end type
type cb_2 from commandbutton within w_caqh_xml_read_maha
end type
type cb_1 from commandbutton within w_caqh_xml_read_maha
end type
type gb_1 from groupbox within w_caqh_xml_read_maha
end type
type dw_experience from datawindow within w_caqh_xml_read_maha
end type
type dw_insurance from datawindow within w_caqh_xml_read_maha
end type
type dw_committees from datawindow within w_caqh_xml_read_maha
end type
type dw_cpr from datawindow within w_caqh_xml_read_maha
end type
type dw_education from datawindow within w_caqh_xml_read_maha
end type
type dw_training from datawindow within w_caqh_xml_read_maha
end type
type dw_settings from datawindow within w_caqh_xml_read_maha
end type
type mle_1 from multilineedit within w_caqh_xml_read_maha
end type
type gb_3 from groupbox within w_caqh_xml_read_maha
end type
type dw_basic from datawindow within w_caqh_xml_read_maha
end type
type dw_reference from datawindow within w_caqh_xml_read_maha
end type
type dw_address from datawindow within w_caqh_xml_read_maha
end type
end forward
...
global w_caqh_xml_read_maha w_caqh_xml_read_maha
...
on w_caqh_xml_read_maha.create
int iCurrent
call super::create
...
this.Control[iCurrent+2]=this.cb_ac
this.Control[iCurrent+3]=this.dw_log_items
this.Control[iCurrent+4]=this.cbx_ac
this.Control[iCurrent+5]=this.pb_1
this.Control[iCurrent+6]=this.cbx_dir
this.Control[iCurrent+7]=this.dw_app_audit
this.Control[iCurrent+8]=this.cbx_pid
this.Control[iCurrent+9]=this.cbx_title
this.Control[iCurrent+10]=this.cb_3
this.Control[iCurrent+11]=this.cb_all
this.Control[iCurrent+12]=this.dw_verifs
this.Control[iCurrent+13]=this.dw_otherids
this.Control[iCurrent+14]=this.dw_verifsxxxx
this.Control[iCurrent+15]=this.dw_audit_trail
this.Control[iCurrent+16]=this.dw_spec_link
this.Control[iCurrent+17]=this.dw_hosp_link
this.Control[iCurrent+18]=this.dw_addr_link
this.Control[iCurrent+19]=this.dw_appointment
this.Control[iCurrent+20]=this.dw_log
this.Control[iCurrent+21]=this.cb_4
this.Control[iCurrent+22]=this.lb_1
this.Control[iCurrent+23]=this.dw_facility_default
this.Control[iCurrent+24]=this.dw_code_lu
this.Control[iCurrent+25]=this.dw_address_lu
this.Control[iCurrent+26]=this.dw_ecfmg
this.Control[iCurrent+27]=this.dw_map_fields
this.Control[iCurrent+28]=this.dw_dea
this.Control[iCurrent+29]=this.dw_claims
this.Control[iCurrent+30]=this.dw_workgap
this.Control[iCurrent+31]=this.dw_hospital
this.Control[iCurrent+32]=this.dw_attest
this.Control[iCurrent+33]=this.dw_specialty
this.Control[iCurrent+34]=this.dw_language
this.Control[iCurrent+35]=this.dw_license
this.Control[iCurrent+36]=this.cb_run
this.Control[iCurrent+37]=this.cb_2
this.Control[iCurrent+38]=this.cb_1
this.Control[iCurrent+39]=this.gb_1
this.Control[iCurrent+40]=this.dw_experience
this.Control[iCurrent+41]=this.dw_insurance
this.Control[iCurrent+42]=this.dw_committees
this.Control[iCurrent+43]=this.dw_cpr
this.Control[iCurrent+44]=this.dw_education
this.Control[iCurrent+45]=this.dw_training
this.Control[iCurrent+46]=this.dw_settings
this.Control[iCurrent+47]=this.mle_1
this.Control[iCurrent+48]=this.gb_3
this.Control[iCurrent+49]=this.dw_basic
this.Control[iCurrent+50]=this.dw_reference
this.Control[iCurrent+51]=this.dw_address
end on

on w_caqh_xml_read_maha.destroy
call super::destroy
