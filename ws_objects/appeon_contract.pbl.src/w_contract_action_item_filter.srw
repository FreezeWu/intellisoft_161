$PBExportHeader$w_contract_action_item_filter.srw
forward
global type w_contract_action_item_filter from window
end type
type cb_2 from commandbutton within w_contract_action_item_filter
end type
type cb_1 from commandbutton within w_contract_action_item_filter
end type
type cb_filter from commandbutton within w_contract_action_item_filter
end type
type dw_filter from u_dw_contract within w_contract_action_item_filter
end type
end forward
...
global w_contract_action_item_filter w_contract_action_item_filter

type variables
Datawindow idw_action_item
end variables

on w_contract_action_item_filter.create
...
on w_contract_action_item_filter.destroy
destroy(this.cb_2)
destroy(this.cb_1)
