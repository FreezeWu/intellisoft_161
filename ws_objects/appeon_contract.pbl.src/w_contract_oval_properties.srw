$PBExportHeader$w_contract_oval_properties.srw
forward
global type w_contract_oval_properties from w_popup
end type
type dw_properties_oval from u_dw within w_contract_oval_properties
end type
type cb_ok from u_cb within w_contract_oval_properties
end type
type cb_cancel from u_cb within w_contract_oval_properties
end type
end forward
...
global w_contract_oval_properties w_contract_oval_properties
...
on w_contract_oval_properties.create
int iCurrent
call super::create
...
on w_contract_oval_properties.destroy
call super::destroy
