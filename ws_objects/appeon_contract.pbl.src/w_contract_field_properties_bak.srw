$PBExportHeader$w_contract_field_properties_bak.srw
forward
global type w_contract_field_properties_bak from w_popup
end type
type tab_properties from tab within w_contract_field_properties_bak
end type
...
type cb_datafill from u_cb within w_contract_field_properties_bak
end type
type dw_properties from u_dw within w_contract_field_properties_bak
end type
type cb_cancel from u_cb within w_contract_field_properties_bak
end type
type st_1 from statictext within w_contract_field_properties_bak
end type
type st_2 from statictext within w_contract_field_properties_bak
end type
type cb_ok from u_cb within w_contract_field_properties_bak
end type
end forward
...
global w_contract_field_properties_bak w_contract_field_properties_bak
...
tab_properties.tabpage_label.dw_2.object.t_fields_label_textcolor.background.color = dw_properties.object.fields_label_textcolor[ll_Row]
tab_properties.tabpage_label.dw_2.object.t_fields_label_textbkcolor.background.color = dw_properties.object.fields_label_textbkcolor[ll_Row]

//BEGIN---Modify by Scofield on 2009-08-27
tab_properties.tabpage_general.dw_1.object.t_fields_textcolor.background.color = dw_properties.object.fields_textcolor[ll_Row]
tab_properties.tabpage_general.dw_1.object.t_fields_textbkcolor.background.color = dw_properties.object.fields_textbkcolor[ll_Row]
...
on w_contract_field_properties_bak.create
int iCurrent
call super::create
...
on w_contract_field_properties_bak.destroy
call super::destroy
...
if ls_coltype = "char(" or ls_coltype = "char" or ls_coltype = "decim" or ls_coltype = "numbe" or ls_coltype = "doubl" or ls_coltype = "real" or ls_coltype =  "long" or ls_coltype =  "int" or ls_coltype =  "ulong" then
	ls_modify = "sys_fields_lookup_field.values = 'Code Lookup	Y/Company	C/User	U/Edit	E/EditMask	M/CheckBox	B/None	N/'"
...
/*
Comment by jervis 07.20.2011
if ls_edit_style <> 'edit' THEN 
	tab_properties.tabpage_edit.dw_3.Modify("data_view_fields_display_only.protect='1' data_view_fields_display_only.Background.Mode='2' data_view_fields_display_only.Background.Color='" + string(rgb(192,192,192)) + "'")
end if
*/
//end of add
...
if inv_data_design.is_open_style = "screen" and inv_data_design.ib_HasNewModify and ( inv_data_design.ii_Screen_id = 6 Or inv_data_design.ii_Screen_id = 7 ) then
	...
	ENd If
	If Pos(  'association,custom_n1, custom_1' , lower(ls_FieldName) ) > 0  Then
