...
type cb_link from commandbutton within w_query_wizard
end type
...
type cb_reset from commandbutton within w_query_wizard
end type
...
type cb_return from commandbutton within w_query_wizard
end type
type cb_setsyntax from commandbutton within w_query_wizard
end type
type cb_about from commandbutton within w_query_wizard
end type
...
type gb_2 from groupbox within w_query_wizard
end type
end forward
...
integer height = 100
integer taborder = 80
string dataobject = "d_sys_fields"
...
//	is_field1 = dw_crit1.GetItemString(dw_crit1.getrow(), "field_name")
//	ls_ftype1 = dw_crit1.GetItemString(dw_crit1.getrow(), "field_datatype")
//	ls_ftype1 = of_GetFieldType(ls_ftype1)	
//	is_field2 = dw_crit2.GetItemString(dw_crit2.getrow(), "field_name")
//	ls_ftype2 = dw_crit2.GetItemString(dw_crit2.getrow(), "field_datatype")
//	ls_ftype2 = of_GetFieldType(ls_ftype2)
//	is_field3 = dw_crit3.GetItemString(dw_crit3.getrow(), "field_name")
//	ls_ftype3 = dw_crit3.GetItemString(dw_crit3.getrow(), "field_datatype")
//	ls_ftype3 = of_GetFieldType(ls_ftype3)
//else
...
//end if
if dw_crit1.dataobject = "dd_ctx_fields1001_dddw" then
	is_field1 = sys_fields_child.GetItemString(sys_fields_child.getrow(), "field_name")
	ls_ftype1 = sys_fields_child.GetItemString(sys_fields_child.getrow(), "field_datatype")
	ls_ftype1 = of_GetFieldType(ls_ftype1)	
	is_field2 = sys_fields_child2.GetItemString(sys_fields_child2.getrow(), "field_name")
	ls_ftype2 = sys_fields_child2.GetItemString(sys_fields_child2.getrow(), "field_datatype")
	ls_ftype2 = of_GetFieldType(ls_ftype2)
	is_field3 = sys_fields_child3.GetItemString(sys_fields_child3.getrow(), "field_name")
	ls_ftype3 = sys_fields_child3.GetItemString(sys_fields_child3.getrow(), "field_datatype")
	ls_ftype3 = of_GetFieldType(ls_ftype3)
else
