$PBExportHeader$pfc_w_frame.srw
...
//(Appeon)Harry 01.21.2014 - V142 ISG-CLX
//If this.windowtype <> mdihelp! Then
If Not( this.windowtype = mdihelp! or this.windowtype = mdi! ) Then
	Return -1
End If 
...
event pfc_microhelp;call super::pfc_microhelp;//////////////////////////////////////////////////////////////////////////////
//
//	Event:  pfc_microhelp
//
//	Arguments:		
...
if gnv_app.of_GetMicrohelp() then
	//this.SetMicroHelp (as_microhelp) //Commented by (Appeon)Harry 04.02.2014 - V142 ISG-CLX
	inv_statusbar.dynamic of_modify('Process', as_microhelp) //(Appeon)Harry 04.02.2014 - new statusbar
end if
end event
