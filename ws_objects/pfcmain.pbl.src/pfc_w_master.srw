$PBExportHeader$pfc_w_master.srw
...
Long il_pfc_width,il_pfc_height
...
public function integer of_setdberrormsg_new (string as_msg)
public function integer of_setdberrormsg_new (string as_msg)
end prototypes
...
If LenA (Trim (ls_helpfile)) > 0 Then
...
Else
	//Start Code Change ---- 03.24.2006 #339 maha
	if LenA(ls_msgparm[1]) < 1 then
		if handle(GetApplication ( ))  = 0 then //development mode only
			of_Messagebox ('pfc_master_dwdberror', gnv_app.iapp_object.DisplayName, "Unable to save data.", information!, Ok!, 1)		
		end if
	else
...
//--------------------------- APPEON BEGIN ---------------------------
//$<rename> 01.13.2006 By: LeiWei
//$<reason> Dynamic calling overloaded functions is unsupported. 
//---------------------------- APPEON END ----------------------------
...
If This.Width = il_pfc_width and This.Height = il_pfc_height Then
	Return 1
End If
il_pfc_width =  This.Width
il_pfc_height = This.Height
//---------------------------- APPEON END ----------------------------
