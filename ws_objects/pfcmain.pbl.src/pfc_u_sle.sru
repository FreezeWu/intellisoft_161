$PBExportHeader$pfc_u_sle.sru
$PBExportComments$PFC SingleLineEdit class
forward
...
//////////////////////////////////////////////////////////////////////////////
//--------------------------- APPEON BEGIN ---------------------------
//$<comment> 2005-08-31 By: Xie Hanwen
//$<reason> CanUndo function of SingleLineEdit control is unsupported.
...
if LenA (ClipBoard()) > 0 and not this.displayonly then
