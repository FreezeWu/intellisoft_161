...
If This.View = ListViewLargeIcon! Or This.View = ListViewSmallIcon! Then
	...
	//$<reason> The AutoArrange property of the ListView control is unsupported.
...
*/
If This.View = ListViewLargeIcon! Or This.View = ListViewSmallIcon! Then
	gnv_app.of_modify_menu_attr( im_view.m_viewitem.m_arrangeicons.m_autoarrange,'Enabled', True)
...
Else
	gnv_app.of_modify_menu_attr( im_view.m_viewitem.m_arrangeicons.m_autoarrange,'Enabled', False)
	gnv_app.of_modify_menu_attr( im_view.m_viewitem.m_arrangeicons.m_autoarrange,'Checked', False)
End If
//---------End Modfiied ------------------------------------------------------
...
ElseIf LeftA(ids_Source.Describe(is_PictureColumn + ".coltype"), 4) = "char" Then
...
ElseIf LeftA(ids_Source.Describe(is_StateColumn + ".coltype"), 4) = "char" Then
	// The column contains a bmp name, so add the picture
