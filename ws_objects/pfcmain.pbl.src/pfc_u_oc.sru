...
//--------------------------- APPEON BEGIN ---------------------------
//$<modify> 2005-08-30 By: Xie Hanwen
//$<reason> The functions relate to clipboad operations are not supported,such as cut ,copy and paste functions.
//	Return this.Cut()
	Return -2
//---------------------------- APPEON END ----------------------------
...
//--------------------------- APPEON BEGIN ---------------------------
//$<modify> 2005-09-02 By: Liang QingShi
//$<reason> Paste function of OLEControl control is unsupported. 
//Return this.Paste()
...
//$<reason> Pastespecial function of OLEControl control is unsupported.
...
if not ib_rmbmenu or LenA (this.objectdata) = 0 then
	return 1
end if
...
//$<reason> The ClassShortName,ClassLongName property of the OLOEControl control  is unsupported.
...
if LenA (ls_classdisplayname) > 0 then
...
//--------------------------- APPEON BEGIN ---------------------------
//$<modify> 2005-09-01 By: Liang QingShi
//$<reason> Updatelinksdialog functions of  OLEControl control  is unsupported.
