...
//$<reason> TotalSelected() function of ListView is unsupported.

//If this.TotalSelected() < 1 Then Return NO_ACTION
If this.SelectedIndex() < 1 Then Return NO_ACTION
...
If isvalid(inv_sort) then
	...
	gnv_app.of_modify_menu_attr( lm_view.m_viewitem.m_arrangeicons,'enabled', false)
	//---------End Modfiied ------------------------------------------------------
end if
...
if this.view = ListViewLargeIcon! or this.view = ListViewSmallIcon! then
	...
	gnv_app.of_modify_menu_attr( lm_view.m_viewitem.m_arrangeicons.m_autoarrange,'enabled', true)
	//---------End Modfiied ------------------------------------------------------
	...
	gnv_app.of_modify_menu_attr( lm_view.m_viewitem.m_arrangeicons.m_autoarrange,'enabled', false)
	gnv_app.of_modify_menu_attr( lm_view.m_viewitem.m_arrangeicons.m_autoarrange,'checked', false)
	//---------End Modfiied ------------------------------------------------------
end if
//--------------------------- APPEON BEGIN ---------------------------
//$<modify> 2005-09-01 By: Liang QingShi
...
//$<reason> Arrange() function of ListView control is unsupported.
// this.Arrange ( )
//---------------------------- APPEON END ----------------------------
...
If KeyFlags = 0 then
	If Key = KeyDelete! then
		...
		if this.deleteitems then
			...
			//--------------------------- APPEON BEGIN ---------------------------
			//$<comment> 2005-09-01 By: Xie Hanwen
			//$<reason> The RetrunValue property and Processed property of the Message object are unsupported.
