$PBExportHeader$appeondatawindow.sru
forward
global type appeondatawindow from datawindow
end type
end forward
...
global appeondatawindow appeondatawindow
...
Function int ConvertDWCP_J(ref str_b astr_obj, ref long al_address, ref long al_len, boolean ab_blob) library "EonAXNVO.dll" alias for "ConvertDWCP_J;Ansi"
...
private function integer of_setrowflag (readonly string as_rowflag)
...
private function long of_getchanges (ref string as_changes, ref blob ab_changes, boolean ab_blob)
private function long of_getfullstate (ref string as_changes, ref blob ab_changes, boolean ab_blob, boolean ab_withdddw)
private function integer of_setchanges (readonly string as_changes, readonly blob ab_changes, boolean ab_blob)
private function integer of_setfullstate (readonly string as_changes, readonly blob ab_changes, boolean ab_blob, boolean ab_withdddw)
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::setfullstate()
//------------------------------------------------------------------------------
// Description: 
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::getfullstate()
//------------------------------------------------------------------------------
// Description: 
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::getchanges()
//------------------------------------------------------------------------------
// Description: 
...
ll_Ret = Of_GetChanges(changes, lb_Changes, FALSE)
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::setchanges()
//------------------------------------------------------------------------------
// Description: 
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::reset()
//------------------------------------------------------------------------------
// Description: 
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_gettype()
//------------------------------------------------------------------------------
...
FOR i = 1 TO nColCount
	...
	IF ab_flag THEN
		nPos = PosA(strColType, '(')
		IF nPos > 0 THEN
			strColType = LeftA(strColType, nPos -1)
		END IF
	END IF
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::getrowfromrowid()
//------------------------------------------------------------------------------
// Description: 
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::getrowidfromrow()
//------------------------------------------------------------------------------
// Description: 
...
ll_Ret = Of_GetChanges(ls_Changes, changes, TRUE)
...
// Returns:  long
//				Returns the row number in buffer. Returns 0 if the row number is not in the current buffer and -1 if an error occurs. 
//				If any argument value is NULL, in PowerBuilder the method returs NULL
//------------------------------------------------------------------------------
// Author:	APPEON		Date: 2005-06
//------------------------------------------------------------------------------
// Revision History: 
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_setdatainfo()
//------------------------------------------------------------------------------
// Description: 
...
//		readonly	string	as_data  		
//	
// Returns:  integer - Returns the number of rows if it success and -1 if error occurs
//------------------------------------------------------------------------------
// Author:	APPEON		Date: 2005-06
//------------------------------------------------------------------------------
// Revision History: 
...
FOR ll_i = 1 TO ll_ColCount
	IF as_validation[ll_i] <> '' THEN
		ls_quotation = "'"
		IF (PosA(as_validation[ll_i], "'") > 0) THEN
			ls_quotation = "~""			
		END IF
...
CHOOSE CASE Lower ( LeftA ( this.Describe ("#"+string(ai_column) + ".ColType" ) , 5 ) )
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_dddwblob()
//------------------------------------------------------------------------------
// Description: 
...
FOR i = 1 TO UpperBound(ai_dddwID)
	...
	// Column name 
	nDddwLen = LenA(as_dddwName[i])
	BlobEdit(blobInt, 1, nDddwLen) //lenght
	blobData += blobInt
	
	//blobData += Blob(as_dddwName[i]) //name
	blobData += Blob(as_dddwName[i], EncodingAnsi!) //Encoding – Harry 11.14.2013//name
	
	// the child DataWindow's name
	strDddw = THIS.DESCRIBE(as_dddwName[i] + ".dddw.name")
	
	nDddwLen = LenA(strDddw)
	BlobEdit(blobInt, 1, nDddwLen) //lenght
	blobData += blobInt
	
	//blobData += Blob(strDddw) //name
	blobData += Blob(strDddw, EncodingAnsi!) //Encoding – Harry 11.14.2013
NEXT

BlobEdit(blobLong, 1, Long(LenA(blobData)))
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::appeongetfullstateex()
//------------------------------------------------------------------------------
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::AppeonSetfullstateEx()
//------------------------------------------------------------------------------
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_getchanges()
//------------------------------------------------------------------------------
// Description: 
// 
//	
...
BlobEdit(lblob_Integer, 1, Integer(9))
BlobEdit(lblob_Long, 1, Long(LenA(lblob_Data)))
...
IF ab_blob THEN
	ab_changes = Blob(Space(ll_Changes),EncodingAnsi!) //Encoding – Nova 11.16.2010
ELSE
...
IF LenA(ab_changes) = 0 AND LenA(as_changes) = 0 THEN ll_Ret = -1
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_getfullstate()
//------------------------------------------------------------------------------
// Description: 
// 
//	
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_setchanges()
//------------------------------------------------------------------------------
// Description: 
// 
//	
...
Blob lb_Result
String ls_Result
Long ll_Address, ll_result, ll_InsertRow
...
// Get type
IF ab_blob THEN
	ls_Type = CharA(BlobMid(ab_changes, 1, 1))
ELSE
	ls_Type = MidA(as_changes, 1, 2)
END IF
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_setfullstate()
//------------------------------------------------------------------------------
// Description: 
// 
//	
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_savedddwdata()
//------------------------------------------------------------------------------
// Description: 
// 
//	
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_importstring()
//------------------------------------------------------------------------------
// Description: 
// 
//	
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_createblob()
//------------------------------------------------------------------------------
// Description: 
...
BlobEdit(bLong, 1, Long(LenA(bPBState)))
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_main_analysis()
//------------------------------------------------------------------------------
// Description: 
...
on appeondatawindow.create
end on

on appeondatawindow.destroy
end on
