$PBExportHeader$w_recruit_screen_setup.srw
forward
global type w_recruit_screen_setup from window
end type
type st_1 from statictext within w_recruit_screen_setup
end type
type cb_close from commandbutton within w_recruit_screen_setup
end type
type dw_2 from datawindow within w_recruit_screen_setup
end type
type dw_prop from datawindow within w_recruit_screen_setup
end type
end forward
...
string title = "Recruitment Screen Setup"
...
global w_recruit_screen_setup w_recruit_screen_setup
...
on w_recruit_screen_setup.create
...
on w_recruit_screen_setup.destroy
destroy(this.st_1)
...
integer taborder = 20
string title = "none"
string dataobject = "d_recruit_screen_setup"
...
IF NOT IsValid(w_field_properties_recruitment) THEN
	Openwithparm(w_field_properties_recruitment, "R")
