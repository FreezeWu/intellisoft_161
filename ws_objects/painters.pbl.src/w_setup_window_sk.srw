$PBExportHeader$w_setup_window_sk.srw
forward
global type w_setup_window_sk from window
end type
type cb_close from commandbutton within w_setup_window_sk
end type
type cb_1 from commandbutton within w_setup_window_sk
end type
type cb_profile_screen_design from commandbutton within w_setup_window_sk
end type
type cb_fax_templates from commandbutton within w_setup_window_sk
end type
type cb_dtl_setup from commandbutton within w_setup_window_sk
end type
type cb_questions from commandbutton within w_setup_window_sk
end type
type cb_profile_design from commandbutton within w_setup_window_sk
end type
type cb_expiring_data_settings from commandbutton within w_setup_window_sk
end type
type cb_lookup from commandbutton within w_setup_window_sk
end type
type cb_letter_storage from commandbutton within w_setup_window_sk
end type
type cb_letter_setup from commandbutton within w_setup_window_sk
end type
type cb_document_type_setup from commandbutton within w_setup_window_sk
end type
type cb_screen_design from commandbutton within w_setup_window_sk
end type
type cb_checklist_setup from commandbutton within w_setup_window_sk
end type
type cb_email_templates from commandbutton within w_setup_window_sk
end type
type cb_group_practice from commandbutton within w_setup_window_sk
end type
type cb_user_setup from commandbutton within w_setup_window_sk
end type
type cb_role_setup from commandbutton within w_setup_window_sk
end type
type cb_facility_setup from commandbutton within w_setup_window_sk
end type
type cb_view_setup from commandbutton within w_setup_window_sk
end type
type gb_1 from groupbox within w_setup_window_sk
end type
type gb_2 from groupbox within w_setup_window_sk
end type
type gb_3 from groupbox within w_setup_window_sk
end type
type gb_4 from groupbox within w_setup_window_sk
end type
type gb_5 from groupbox within w_setup_window_sk
end type
type gb_6 from groupbox within w_setup_window_sk
end type
type gb_7 from groupbox within w_setup_window_sk
end type
type gb_8 from groupbox within w_setup_window_sk
end type
type gb_9 from groupbox within w_setup_window_sk
end type
end forward
...
global w_setup_window_sk w_setup_window_sk

on w_setup_window_sk.create
