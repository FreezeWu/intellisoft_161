$PBExportHeader$w_logon_screen_isg.srw
forward
global type w_logon_screen_isg from w_response
end type
type st_id from statictext within w_logon_screen_isg
end type
type st_welcome from statictext within w_logon_screen_isg
end type
type p_gear from picture within w_logon_screen_isg
end type
type st_isg from statictext within w_logon_screen_isg
end type
type st_program from statictext within w_logon_screen_isg
end type
type cb_cancel_button from commandbutton within w_logon_screen_isg
end type
type cb_1 from commandbutton within w_logon_screen_isg
end type
type pb_5 from picturebutton within w_logon_screen_isg
end type
type pb_9 from picturebutton within w_logon_screen_isg
end type
type pb_3 from picturebutton within w_logon_screen_isg
end type
type pb_8 from picturebutton within w_logon_screen_isg
end type
type pb_2 from picturebutton within w_logon_screen_isg
end type
type pb_7 from picturebutton within w_logon_screen_isg
end type
type pb_4 from picturebutton within w_logon_screen_isg
end type
type pb_1 from picturebutton within w_logon_screen_isg
end type
type p_2 from picture within w_logon_screen_isg
end type
type shl_website from statichyperlink within w_logon_screen_isg
end type
type sle_pwtestdb from singlelineedit within w_logon_screen_isg
end type
type sle_pwtest from singlelineedit within w_logon_screen_isg
end type
type cbx_1 from checkbox within w_logon_screen_isg
end type
type sle_user_id from singlelineedit within w_logon_screen_isg
end type
type sle_password from singlelineedit within w_logon_screen_isg
end type
type st_pw from statictext within w_logon_screen_isg
end type
type cb_ok from u_cb within w_logon_screen_isg
end type
type cb_close from u_cb within w_logon_screen_isg
end type
type rb_test from radiobutton within w_logon_screen_isg
end type
type rb_tutor from radiobutton within w_logon_screen_isg
end type
type rb_prod from radiobutton within w_logon_screen_isg
end type
type p_1 from picture within w_logon_screen_isg
end type
type r_1 from rectangle within w_logon_screen_isg
end type
type st_iss from statictext within w_logon_screen_isg
end type
type p_logo from picture within w_logon_screen_isg
end type
type cb_support from commandbutton within w_logon_screen_isg
end type
type st_forgot_pw from statictext within w_logon_screen_isg
end type
type st_version from statictext within w_logon_screen_isg
end type
type pb_6 from picturebutton within w_logon_screen_isg
end type
end forward
...
global w_logon_screen_isg w_logon_screen_isg
...
this.Control[iCurrent+1]=this.st_id
this.Control[iCurrent+2]=this.st_welcome
this.Control[iCurrent+3]=this.p_gear
this.Control[iCurrent+4]=this.st_isg
this.Control[iCurrent+5]=this.st_program
this.Control[iCurrent+6]=this.cb_cancel_button
this.Control[iCurrent+7]=this.cb_1
this.Control[iCurrent+8]=this.pb_5
this.Control[iCurrent+9]=this.pb_9
this.Control[iCurrent+10]=this.pb_3
this.Control[iCurrent+11]=this.pb_8
...
this.Control[iCurrent+17]=this.shl_website
this.Control[iCurrent+18]=this.sle_pwtestdb
this.Control[iCurrent+19]=this.sle_pwtest
this.Control[iCurrent+20]=this.cbx_1
this.Control[iCurrent+21]=this.sle_user_id
this.Control[iCurrent+22]=this.sle_password
this.Control[iCurrent+23]=this.st_pw
this.Control[iCurrent+24]=this.cb_ok
this.Control[iCurrent+25]=this.cb_close
this.Control[iCurrent+26]=this.rb_test
this.Control[iCurrent+27]=this.rb_tutor
this.Control[iCurrent+28]=this.rb_prod
this.Control[iCurrent+29]=this.p_1
this.Control[iCurrent+30]=this.r_1
this.Control[iCurrent+31]=this.st_iss
this.Control[iCurrent+32]=this.p_logo
this.Control[iCurrent+33]=this.cb_support
this.Control[iCurrent+34]=this.st_forgot_pw
this.Control[iCurrent+35]=this.st_version
this.Control[iCurrent+36]=this.pb_6
end on

on w_logon_screen_isg.destroy
call super::destroy
destroy(this.st_id)
...
// this.backcolor = intelli_purple  //Start Code Change ----09.11.2013 #V14 maha //Start Code Change ----01.19.2016 #V15 maha - removed
...
st_version.text+=  " " + CharA ( 169 ) + "ISG Group LLC 1998-2015" //maha 04.02.2010 - added
...
//Start Code Change ----01.19.2016 #V15 maha - reset the text size
pb_1.textsize = 28
pb_2.textsize = 28
pb_3.textsize = 28
pb_4.textsize = 28
...
pb_8.textsize = 28
pb_9.textsize = 28
//End Code Change ----01.19.2016 

//Added by Appeon long.zhang 01.22.2016 (Walkaround for Web version)
if AppeonGetClientType() = 'WEB' Then this.height += 40
...
string picturename = "mainscreen.jpg"
...
string picturename = "checklist linking.png"
long textcolor = 16711680
end type
...
string picturename = "group 1.jpg"
long textcolor = 16711680
end type
...
string picturename = "actions 2.jpg"
long textcolor = 16711680
end type
...
string picturename = "steth 2.jpg"
long textcolor = 16711680
end type
...
//this.backcolor = INTELLI_PURPLE
//THIS.textcolor = INTELLI_orange
this.textcolor = INTELLI_PURPLE_12
this.backcolor = INTELLI_PURPLE
end event
...
string picturename = "report 1.jpg"
long textcolor = 16711680
end type
