$PBExportHeader$w_home_buttons_org.srw
forward
global type w_home_buttons_org from w_sheet
end type
type pb_3 from picturebutton within w_home_buttons_org
end type
type pb_6 from picturebutton within w_home_buttons_org
end type
type pb_9 from picturebutton within w_home_buttons_org
end type
type pb_8 from picturebutton within w_home_buttons_org
end type
type pb_5 from picturebutton within w_home_buttons_org
end type
type pb_2 from picturebutton within w_home_buttons_org
end type
type pb_1 from picturebutton within w_home_buttons_org
end type
type pb_4 from picturebutton within w_home_buttons_org
end type
type pb_7 from picturebutton within w_home_buttons_org
end type
type r_1 from rectangle within w_home_buttons_org
end type
type st_home from statictext within w_home_buttons_org
end type
end forward
...
global w_home_buttons_org w_home_buttons_org
...
this.Control[iCurrent+11]=this.st_home
end on

on w_home_buttons_org.destroy
call super::destroy
destroy(this.pb_3)
destroy(this.pb_6)
destroy(this.pb_9)
