$PBExportHeader$w_logon_screen_for_16.srw
forward
global type w_logon_screen_for_16 from w_response
end type
type st_welcome from statictext within w_logon_screen_for_16
end type
type p_gear from picture within w_logon_screen_for_16
end type
type st_isg from statictext within w_logon_screen_for_16
end type
type cb_cancel_button from commandbutton within w_logon_screen_for_16
end type
type cb_1 from commandbutton within w_logon_screen_for_16
end type
type pb_5 from picturebutton within w_logon_screen_for_16
end type
type pb_9 from picturebutton within w_logon_screen_for_16
end type
type pb_3 from picturebutton within w_logon_screen_for_16
end type
type pb_8 from picturebutton within w_logon_screen_for_16
end type
type pb_2 from picturebutton within w_logon_screen_for_16
end type
type pb_6 from picturebutton within w_logon_screen_for_16
end type
type pb_7 from picturebutton within w_logon_screen_for_16
end type
type pb_4 from picturebutton within w_logon_screen_for_16
end type
type pb_1 from picturebutton within w_logon_screen_for_16
end type
type p_2 from picture within w_logon_screen_for_16
end type
type shl_website from statichyperlink within w_logon_screen_for_16
end type
type sle_pwtestdb from singlelineedit within w_logon_screen_for_16
end type
type sle_pwtest from singlelineedit within w_logon_screen_for_16
end type
type cbx_1 from checkbox within w_logon_screen_for_16
end type
type rb_test from radiobutton within w_logon_screen_for_16
end type
type rb_tutor from radiobutton within w_logon_screen_for_16
end type
type rb_prod from radiobutton within w_logon_screen_for_16
end type
type p_1 from picture within w_logon_screen_for_16
end type
type r_1 from rectangle within w_logon_screen_for_16
end type
type st_iss from statictext within w_logon_screen_for_16
end type
type p_logo from picture within w_logon_screen_for_16
end type
type cb_support from commandbutton within w_logon_screen_for_16
end type
type st_forgot_pw from statictext within w_logon_screen_for_16
end type
type dw_image from datawindow within w_logon_screen_for_16
end type
type st_id from statictext within w_logon_screen_for_16
end type
type sle_user_id from singlelineedit within w_logon_screen_for_16
end type
type st_pw from statictext within w_logon_screen_for_16
end type
type sle_password from singlelineedit within w_logon_screen_for_16
end type
type cb_ok from u_cb within w_logon_screen_for_16
end type
type cb_close from u_cb within w_logon_screen_for_16
end type
type st_program from statictext within w_logon_screen_for_16
end type
type st_version from statictext within w_logon_screen_for_16
end type
type cbx_remember from checkbox within w_logon_screen_for_16
end type
end forward
...
global w_logon_screen_for_16 w_logon_screen_for_16
...
//-------------------------------- RP 1.26.2016 -------------------------------------
constant long COLOR_BACKGROUND =    RGB(135 ,117, 182)  //  RGB(41 ,38, 109)        // rgb(25, 48, 72) slate blue
constant long COLOR_TEXT =	 rgb(255, 255, 255) // rgb(172, 172, 172)

//constant long INTELLI_PURPLE = RGB(80 ,0, 170) v92
//constant long INTELLI_PURPLE = RGB(35 ,0, 105)
//constant long INTELLI_PURPLE = RGB(41 ,38, 109) V15
constant long INTELLI_PURPLE = RGB(135 ,117, 182) //V16
...
on w_logon_screen_for_16.create
int iCurrent
call super::create
...
on w_logon_screen_for_16.destroy
call super::destroy
...
st_program.textColor = COLOR_TEXT   //rgb(192, 192, 172)
