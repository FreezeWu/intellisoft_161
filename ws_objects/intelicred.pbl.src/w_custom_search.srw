$PBExportHeader$w_custom_search.srw
forward
global type w_custom_search from window
end type
type dw_crit2 from datawindow within w_custom_search
end type
type dw_crit3 from datawindow within w_custom_search
end type
type dw_crit1 from datawindow within w_custom_search
end type
type st_none from statictext within w_custom_search
end type
type cb_ibatch from commandbutton within w_custom_search
end type
type st_7 from statictext within w_custom_search
end type
type cb_syntax from commandbutton within w_custom_search
end type
type cb_2 from commandbutton within w_custom_search
end type
type st_null3 from statictext within w_custom_search
end type
type st_null2 from statictext within w_custom_search
end type
type st_null1 from statictext within w_custom_search
end type
type cb_view_ver from commandbutton within w_custom_search
end type
type cb_view_audit from commandbutton within w_custom_search
end type
type cbx_1 from checkbox within w_custom_search
end type
type st_date4 from statictext within w_custom_search
end type
type sle_valueupdate from singlelineedit within w_custom_search
end type
type dw_vupdate from datawindow within w_custom_search
end type
type ddlb_3 from dropdownlistbox within w_custom_search
end type
type dw_crit3old from datawindow within w_custom_search
end type
type st_vers_found from statictext within w_custom_search
end type
type st_rf from statictext within w_custom_search
end type
type cb_view from commandbutton within w_custom_search
end type
type st_8 from statictext within w_custom_search
end type
type st_date3 from statictext within w_custom_search
end type
type st_date2 from statictext within w_custom_search
end type
type st_date1 from statictext within w_custom_search
end type
type dw_v3 from datawindow within w_custom_search
end type
type dw_v2 from datawindow within w_custom_search
end type
type dw_v1 from datawindow within w_custom_search
end type
type ddlb_2 from dropdownlistbox within w_custom_search
end type
type ddlb_1 from dropdownlistbox within w_custom_search
end type
type st_6 from statictext within w_custom_search
end type
type dw_resp_code from datawindow within w_custom_search
end type
type st_5 from statictext within w_custom_search
end type
type st_4 from statictext within w_custom_search
end type
type st_3 from statictext within w_custom_search
end type
type st_2 from statictext within w_custom_search
end type
type st_1 from statictext within w_custom_search
end type
type sle_value3 from singlelineedit within w_custom_search
end type
type dw_crit_update from datawindow within w_custom_search
end type
type dw_crit2_old from datawindow within w_custom_search
end type
type dw_crit1old from datawindow within w_custom_search
end type
type sle_value2 from singlelineedit within w_custom_search
end type
type sle_value1 from singlelineedit within w_custom_search
end type
type dw_table from datawindow within w_custom_search
end type
type cb_3 from commandbutton within w_custom_search
end type
type cb_find from commandbutton within w_custom_search
end type
type cb_1 from commandbutton within w_custom_search
end type
type gb_7 from groupbox within w_custom_search
end type
type gb_6 from groupbox within w_custom_search
end type
type gb_5 from groupbox within w_custom_search
end type
type gb_4 from groupbox within w_custom_search
end type
type gb_3 from groupbox within w_custom_search
end type
type gb_2 from groupbox within w_custom_search
end type
type gb_1 from groupbox within w_custom_search
end type
type cb_update from commandbutton within w_custom_search
end type
type dw_select from datawindow within w_custom_search
end type
type dw_audit from datawindow within w_custom_search
end type
type dw_verifs from datawindow within w_custom_search
end type
type st_9 from statictext within w_custom_search
end type
end forward
...
dw_crit2_old dw_crit2_old
dw_crit1old dw_crit1old
...
global w_custom_search w_custom_search
...
boolean ib_cancel = true
end variables

forward prototypes
public subroutine of_insert_row ()
public function integer of_value_setup (datawindow adw_curr)
public function integer of_backup (datawindow adw_curr)
end prototypes
...
public function integer of_value_setup (datawindow adw_curr);//Start Code Change ----10.18.2013 #V14 maha - added function

datawindow ldw_curr
datawindow ldw_value
singlelineedit lo_value
dropdownlistbox lo_oper
statictext lo_date
datawindowchild dwchild
integer li_set
string ltable
...
if ldw_curr.getitemstring(ldw_curr.getrow(),"lookup_field") = "Y" then
	dw_v1.visible = true
	lo_value.visible = false
	ltable = ldw_curr.getitemstring(ldw_curr.getrow(),"lookup_code")
	if  ldw_curr.getitemstring(ldw_curr.getrow(),"lookup_type") = "C" then
		ldw_value.dataobject = "d_c_look"
		field = "description"
	elseif  ldw_curr.getitemstring(ldw_curr.getrow(),"lookup_type") = "A" then
		ldw_value.dataobject = "d_a_look"
		field = "entity_name_original"
	end if
	ldw_value.settransobject(sqlca)
	//dw_v1.retrieve()
	ldw_value.GetChild( field, dwchild )
	dwchild.SetTransObject( SQLCA )
	dwchild.Retrieve(ltable)
	dwchild.InsertRow( 1 )
	ldw_value.insertrow(1)
else
	ldw_value.visible = false
	lo_value.visible = true
	lo_value.text = ""
end if

ls_field =  ldw_curr.getitemstring(ldw_curr.getrow(),"sys_fields_field_name")
d =  ldw_curr.getitemstring(ldw_curr.getrow(),"sys_fields_field_type")
if d = "D" then 
	lo_date.visible = true
else
	lo_date.visible = false
end if

lo_oper.selectitem( 1)   //Start Code Change ----10.18.2013 #V14 maha

return 1
end function

public function integer of_backup (datawindow adw_curr);//Start Code Change ----10.18.2013 #V14 maha - added function
//backup of of_value_setup
datawindow ldw_curr
datawindow ldw_value
singlelineedit lo_value
dropdownlistbox lo_oper
...
this.dw_crit3old=create dw_crit3old
...
this.dw_crit2_old=create dw_crit2_old
this.dw_crit1old=create dw_crit1old
...
destroy(this.dw_crit2_old)
destroy(this.dw_crit1old)
...
dw_crit1old.selectrow(0, False)
dw_crit2_old.selectrow(0, False)
dw_crit3old.selectrow(0, False)
...
event rowfocuschanged;of_value_setup(this)  //Start Code Change ----10.18.2013 #V14 maha - changed to function call
...
of_value_setup(this)  //Start Code Change ----10.18.2013 #V14 maha - changed to function call
...
of_value_setup(this) //Start Code Change ----02.24.2016 #V15 maha

cb_update.enabled = false
end event

event rowfocuschanged;
//of_value_setup(this)  //Start Code Change ----10.18.2013 #V14 maha - changed to function call   //Start Code Change ----2.24.2016 #V15 maha - moved to clicked
...
ls_search = "Select * from " + is_table  //Start Code Change ----02.24.2016 #V15 maha
...
ls_ftype1 = dw_crit1.getitemstring(dw_crit1old.getrow(),"sys_fields_field_type")
ls_ftype2 = dw_crit2.getitemstring(dw_crit2_old.getrow(),"sys_fields_field_type")
ls_ftype3 = dw_crit3.getitemstring(dw_crit3old.getrow(),"sys_fields_field_type")
...
//ls_search = "Select * from " + is_table //maha 2.24.2016
 
//ls_search = ls_search + is_where //maha 2.24.2016
...
long textcolor = 255
long backcolor = 33551856
string text = "New functional version not completed"
boolean focusrectangle = false
end type
