...
type cb_grid from commandbutton within pfc_cst_u_extended_search
end type
type cb_adv from commandbutton within pfc_cst_u_extended_search
end type
type cb_dept_help from commandbutton within pfc_cst_u_extended_search
end type
type cb_facility_help from commandbutton within pfc_cst_u_extended_search
end type
type cb_view_help from commandbutton within pfc_cst_u_extended_search
end type
type cb_loc from commandbutton within pfc_cst_u_extended_search
end type
type pb_lost from picturebutton within pfc_cst_u_extended_search
end type
type dw_prof_suffix from datawindow within pfc_cst_u_extended_search
end type
type r_new from rectangle within pfc_cst_u_extended_search
end type
...
type cbx_valid from checkbox within pfc_cst_u_extended_search
end type
type cb_29 from u_search_letter_button within pfc_cst_u_extended_search
end type
type rb_appr from radiobutton within pfc_cst_u_extended_search
end type
type rb_ver from radiobutton within pfc_cst_u_extended_search
end type
type rb_de from radiobutton within pfc_cst_u_extended_search
end type
...
type cb_clear from u_search_letter_button within pfc_cst_u_extended_search
end type
type gb_letters from groupbox within pfc_cst_u_extended_search
end type
type ddlb_status from dropdownlistbox within pfc_cst_u_extended_search
end type
type gb_search from groupbox within pfc_cst_u_extended_search
end type
type rb_aud from radiobutton within pfc_cst_u_extended_search
end type
type dw_tasksxxx from u_dw within pfc_cst_u_extended_search
end type
type uo_grid from u_search_screen_grid within pfc_cst_u_extended_search
end type
type gb_status from groupbox within pfc_cst_u_extended_search
end type
type st_hide from statictext within pfc_cst_u_extended_search
end type
type st_dw_search_border from statictext within pfc_cst_u_extended_search
end type
...
gb_search gb_search
rb_aud rb_aud
dw_tasksxxx dw_tasksxxx
uo_grid uo_grid
gb_status gb_status
st_hide st_hide
st_dw_search_border st_dw_search_border
cb_close cb_close
end type
...
boolean ib_advanced = true //maha 04.20.2015
boolean ib_show_grid = false //maha 05.07.2015
...
public function integer of_show_advanced ()
public function integer of_resize (string as_type)
public function integer of_set_security ()
public function integer of_hide_mod_fields (integer ai_view)
public function integer of_set_app_filter ()
...
event ue_setresize();// RP added 1.7.2016 FOR DEMO - NOT OPTIMAL

return //(Bug #5417) alfee 11.18.2016

//called from multiple places in w_prac_data_1
dw_search.setredraw( false)  //Start Code Change ----07.28.2016 #V152 maha
dw_search.of_setResize(FALSE)
dw_search.of_setResize(TRUE)
//Start Code Change ----05.12.2016 #V15 maha - modified for App
if gs_cust_type = "I" then
	dw_search.inv_resize.of_setOrigSize(long(dw_search.object.active_status.x) + long(dw_search.object.active_status.width) + 87, dw_search.height)
	dw_search.inv_resize.of_setMinSize(dw_search.inv_resize.of_getWidth() * 0.9, dw_search.height)
	dw_search.inv_resize.of_register("last_name", 0, 0, 25, 0)
	dw_search.inv_resize.of_register("last_name_t", 0, 0, 25, 0)
	dw_search.inv_resize.of_register("compute_1", 0, 0, 25, 0)
	dw_search.inv_resize.of_register("first_name", 25, 0, 0, 0)
	dw_search.inv_resize.of_register("first_name_t", 25, 0, 0, 0)
	dw_search.inv_resize.of_register("middle_name", 40, 0, 0, 0)
	dw_search.inv_resize.of_register("middle_name_t", 40, 0, 0, 0)
	dw_search.inv_resize.of_register("code_lookup_code", 50, 0, 0, 0)
	dw_search.inv_resize.of_register("code_lookup_code_t", 50, 0, 0, 0)
	//dw_search.inv_resize.of_register("prof_code", 50, 0, 0, 0)
	//dw_search.inv_resize.of_register("prof_code_t", 50, 0, 0, 0)
	dw_search.inv_resize.of_register("facility_name", 50, 0, 50, 0)
	dw_search.inv_resize.of_register("facility_name_t", 50, 0, 50, 0)
	dw_search.inv_resize.of_register("ssn", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("ssn_t", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("date_of_birth", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("date_of_birth_t", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("npi_number", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("npi_number_t", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("prac_id", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("prac_id_t", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("provider_id", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("provider_id_t", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("active_status", 100, 0, 0, 0)
	dw_search.inv_resize.of_register("active_status_t", 100, 0, 0, 0)
//	dw_search.inv_resize.of_register("pd_affil_stat_apptmnt_start_date", 100, 0, 0, 0)
//	dw_search.inv_resize.of_register("pd_affil_stat_apptmnt_start_date_t", 100, 0, 0, 0)
//	dw_search.inv_resize.of_register("pd_affil_stat_apptmnt_end_date", 100, 0, 0, 0)
//	dw_search.inv_resize.of_register("pd_affil_stat_apptmnt_end_date_t", 100, 0, 0, 0)
else
	dw_search.inv_resize.of_setOrigSize(long(dw_search.object.pd_affil_stat_apptmnt_end_date.x) + long(dw_search.object.pd_affil_stat_apptmnt_end_date.width) + 87, dw_search.height)
	dw_search.inv_resize.of_setMinSize(dw_search.inv_resize.of_getWidth() * 0.9, dw_search.height)
	dw_search.inv_resize.of_register("last_name", 0, 0, 25, 0)
	dw_search.inv_resize.of_register("last_name_t", 0, 0, 25, 0)
	dw_search.inv_resize.of_register("compute_1", 0, 0, 25, 0)
	dw_search.inv_resize.of_register("first_name", 25, 0, 15, 0)
	dw_search.inv_resize.of_register("first_name_t", 25, 0, 15, 0)
	dw_search.inv_resize.of_register("middle_name", 40, 0, 10, 0)
	dw_search.inv_resize.of_register("middle_name_t", 40, 0, 10, 0)
	dw_search.inv_resize.of_register("code_lookup_code", 50, 0, 0, 0)
	dw_search.inv_resize.of_register("code_lookup_code_t", 50, 0, 0, 0)
	dw_search.inv_resize.of_register("prof_code", 50, 0, 0, 0)
	dw_search.inv_resize.of_register("prof_code_t", 50, 0, 0, 0)
...
//End Code Change ----05.12.2016

dw_search.event resize(0, dw_search.width, dw_search.height)

dw_search.setredraw( true)  //Start Code Change ----07.28.2016 #V152 maha
...
integer li_search_type
integer li_show_actions

//messagebox(is_open_for, as_open_for)
//messagebox("",1)
//Start Code Change ----07.25.2011 #V11 maha - stripped cb_new codes to separate if to simplify
cb_iverify.Visible = false

select adv_search, show_grid into :li_search_type, :li_show_actions from security_users where user_id = :gs_user_id;

//messagebox("",is_open_for)
If  is_open_for = "DATAENTRY" THEN
	cb_new.Visible = true
	r_new.visible = true  //Start Code Change ----07.25.2011 #V11 maha 
	if li_search_type = 1 then
		ib_advanced = true  
	else
		ib_advanced = false   //Start Code Change ----05.07.2015 #V15 maha
	end if
	
	if li_show_actions = 1 then
		ib_show_grid =true
	else
		ib_show_grid = false //Start Code Change ----05.07.2015 #V15 maha
	end if
ELSE
...
ELSEIF LeftA( is_open_for, 10 ) = "INTELLIAPP" THEN //used when selecting providers for app printing
	...
	//Start Code Change ----03.07.2016 #V15 maha - added
	ib_advanced = true
//	ddlb_status.visible = true
//	gb_status.visible = true
	//End Code Change ----03.07.2016
...
ELSEIF is_open_for = "DELETE" THEN
	...
	cbx_status.Enabled = False
	 //Start Code Change ----03.15.2016 #V15 maha
	pb_lost.Visible = False
	cb_adv.Visible = False
	cb_grid.Visible = False
	uo_grid.Visible = False
	 //End Code Change ----03.15.2016
	 
	 //------------------- APPEON BEGIN -------------------
	//<$>added:long.zhang 03.28.2016
	//<$>reason:move to right position. BugL032802.
	cbx_valid.x = cb_adv.x 
	cbx_valid.y = cb_adv.y 
	//------------------- APPEON END -------------------
elseif is_open_for = "ACTIONITEMS" or is_open_for = 'MEETINGS' or is_open_for = "PRIVILEGE" or  is_open_for = "SURVEY" or  is_open_for = "SINGLE" then //02.25.2011 By Evan
	//cb_new.Visible = False
...
IF is_open_for <> "DELETE" THEN  //Start Code Change ----03.15.2016 #V15 maha
	of_show_advanced( ) //Start Code Change ----05.07.2015 #V15 maha
end if
...
of_set_security( )  //Start Code Change ----03.16.2016 #V15 maha
...
if ii_user_view > 0 then //maha 052104
	...
	//<$>reason:V14.2 Applause Bug #4836 - Setting up a user with access to one view, they login and see "1" in the select view field
	//dw_view.SetItem( 1, "data_view_id", 1 )
	If dwchild.Find('data_view_id = 1', 1, dwchild.RowCount()) > 0 Then
		dw_view.SetItem( 1, "data_view_id", 1 )
	ElseIf dwchild.RowCount() > 0 Then
		dw_view.SetItem( 1, "data_view_id", dwchild.GetItemNumber(1, 'data_view_id') )
	End If
	//------------------- APPEON END -------------------
end if
dw_view.SetRow( 1 )
...
//Start Code Change ----05.11.2016 #V15 maha - no longer user see of_hide_mod_fields
integer i
...
Choose case ls_search_type
	...
	//case "I.D."
		ls_fld = "prac_id"
	case  "Last Name", "Last Name / Entity"   //Start Code Change ----05.25.2016 #V152 maha
		ls_fld = "last_name"
	case "SS #" 
		ls_fld = "ssn"
	case "Provider ID" 
	...
	case "CAQH ID"  //Start Code Change ----09.20.2017 #V154 maha
		ls_fld = "caqh_id"
END Choose
...
ELSEIF ls_fld = "Professional Suffix" THEN  //Start Code Change ----12.04.2012 #V12 maha
		ls_sql = ls_sql + " AND ( pd_basic.prof_suffix = "  + string(il_prof) + ") "	   //ls_sql = ls_sql + " AND ( prof_suffix = "  + string(il_prof) + ") " //Copied from v142 by Appeon long.zhang 03.11.2016 (BugL031101)
...
//End Code Change---06.08.2010	
	...
	ELSEIF ls_fld = "caqh_id" then  //Start Code Change ----09.20.2017 #V154 maha
		ls_sql = ls_sql + " AND pd_basic.caqh_id = '" + sle_srch_val.Text + "'"
...
dw_search.setredraw( false)  //Start Code Change ----07.28.2016 #V152 maha
li_rc = dw_search.Retrieve( )
post triggerevent( "ue_setresize")  //Start Code Change ----07.28.2016 #V152 maha

dw_search.setredraw( true) //(Appeon)Stephen 12.26.2016 - Bug ID #5456 for Case # 00068402: I can't work!!! Help! 
if li_rc < 0 then
	openwithparm (w_sql_msg, ls_sql)
end if
...
if as_letter = "Refresh" then
	//Start Code Change ----07.20.2017 #V154 maha - search first on prac & facility, then on just prac (se;lect medical)
	fp = dw_search.find("prac_id = " + string(gl_prac_id) + " and parent_facility_id = "  + string(gi_parent_facility) , 1,li_rc )
	if fp = 0 then fp = dw_search.find("prac_id = " + string(gl_prac_id), 1,li_rc ) 
...
//of_hide_mod_fields(ii_user_view ) //Start Code Change ----04.12.2016 #V15 maha - for 15.2
//of_hide_ssn()  //Start Code Change ----05.11.2016 #V15 maha - now part of  of_hide_mod_fields

//Start Code Change ----03.16.2016 #V15 maha
li_dvid = dw_view.getitemnumber(1, "data_view_id")
of_hide_mod_fields( li_dvid)
...
ELSEIF is_open_for = "SKS" then  //SK Practitioner Folder - alfee 08.31.2010	
	...
	ist_search.ll_facility[1] = gi_parent_facility
	Closewithreturn( Parent, ist_search)	
ELSEIF is_open_for = "SINGLE" THEN  //Start Code Change ----10.28.2016 #V153 maha - entity painter
	CloseWithReturn( Parent, String( ll_prac_id ))
END IF
...
public function integer of_show_advanced (); //Start Code Change ----05.07.2015 #V15 maha

 //ib_advanced.true = change to advanced mode (currently in simple)
 
 if ib_advanced = true then
	cb_adv.text = "Simple"
else
	cb_adv.text = "Advanced"
end if
 
 //Start Code Change ----11.10.2015 #V15 maha - action grid security
IF w_mdi.of_security_access( 7808 ) = 0 THEN
	ib_show_grid = false
	uo_grid.visible = false
	cb_grid.visible = false
ELSE
	if ib_show_grid = false then
		uo_grid.visible = false
		ib_show_grid = false
		cb_grid.text = 'Show Actions' //Added by Appeon long.zhang 12.21.2015 (BugL122101)
	else
		uo_grid.visible = true
		ib_show_grid = true
		pb_lost.visible = false
		cb_grid.text = 'Hide Actions' //Added by Appeon long.zhang 12.21.2015 (BugL122101)
	end if
end if
 //End Code Change ----11.10.2015
 
  //Start Code Change ----12.21.2015 #V15 maha
 if ib_advanced then 
	pb_lost.visible = true
	gb_search.visible = true
	ddlb_status.visible = true
	gb_status.visible = true
	rb_appr.visible = true
	rb_aud.visible = true
	rb_de.visible = true
	rb_ver.visible = true
	cb_clear.visible = true
	of_set_app_filter( ) //Start Code Change ----06.230.2016 #V152 maha
	//---------Begin Added by (Appeon)Stephen 02.01.2016 for V15.1 Bug #4964 - The simple search screen is showing the Select Department option in provider list--------
	...
	//---------Begin Added by (Appeon)Harry 08.19.2016 for BugH040801
	choose case ddlb_search_type.text
		case "Address - Tax Id", "NPI #" , "SS #"
			if ib_advanced = true then cbx_valid.visible = true
		case else 
	...
	rb_appr.visible = false
	rb_aud.visible = false
	rb_de.visible = false
	rb_ver.visible = false
	cb_clear.visible = false
	//---------Begin Added by (Appeon)Stephen 02.01.2016 for V15.1 Bug #4964 - The simple search screen is showing the Select Department option in provider list--------
	IF gi_dept_security = 1 THEN
		gb_department.Visible = false
		dw_department.Visible = false
		cb_dept_help.Visible = false
	end if
	//---------End Added ------------------------------------------------------
	
	cbx_valid.visible = false //(Appeon)Harry 08.19.2016 - BugH040801
end if
  //End Code Change ----12.21.2015	
 
	 
If isvalid(iw_prac_folder) THEN
	iw_prac_folder.triggerevent(resize!)
elseif isvalid(w_extended_search_new) THEN
	if is_open_for = "DELETE" then   //Start Code Change ----12.03.2015 #V15 maha
		of_resize("DELETE")
	elseif is_open_for = "INTELLIAPP" then  //Start Code Change ----03.07.2016 #V15 maha
		of_resize("Else")	
	elseif is_open_for = "MEETINGS" then  //Start Code Change ----03.07.2016 #V15 maha
		of_resize("Else")
	elseif is_open_for =	"REPORTS" then  //Start Code Change ----05.19.2016 #V152 maha
		of_resize("ADV")
	else
		of_resize("New")
	end if
elseif isvalid(w_extended_search_app) THEN
	if is_open_for = "DELETE" then   //Start Code Change ----12.03.2015 #V15 maha
		of_resize("DELETE")
	else
		of_resize("Else")
	end if
else   //Start Code Change ----12.03.2015 #V15 maha
	of_resize("ADV")
end if
...
public function integer of_resize (string as_type); //Start Code Change ----06.10.2015 #V15 maha - added
//called from of_show_advanced
// DOES NOT EFFECT PROVIDER FOLDER
// messagebox("",as_type) //Comment by Appeon long.zhang 02.15.2016 (BugL021503)
if as_type = "New" then
	dw_search.width = this.width - 40
	dw_search.y = gb_department. y + gb_department.height + 10
	dw_search.height = this.height - dw_search.y -20
	cb_grid.visible = false
	cb_adv.visible = false
	ddlb_status.visible = false
	gb_search.visible = false
 //Start Code Change ----12.03.2015 #V15 maha
elseif  as_type = "ADV" then   //called from QA
	dw_search.width = this.width - 40
	dw_search.y = gb_department. y + gb_department.height + 10
	dw_search.height = this.height - dw_search.y -20
	cb_grid.visible = false
...
elseif  as_type = "DELETE" then
	dw_search.width = this.width - 40
	dw_search.y = gb_facility. y + gb_facility.height + 10
	dw_search.height = this.height - dw_search.y -20
	cb_grid.visible = false
	cb_adv.visible = false
	gb_search.visible = false	
	...
	gb_view.visible = false
	dw_view.visible = false
	cb_view_help.visible = false

else  //Start Code Change ----12.07.2015 #V15 maha
	dw_search.width = this.width - 40
	dw_search.y = gb_department. y + gb_department.height + 10
	dw_search.height = this.height - dw_search.y -20
	cb_grid.visible = false
...
public function integer of_set_security ();//Start Code Change ----03.16.2016 #V15 maha - called from of_open_for

// 'new' button security - moved from w_mdi
IF w_mdi.of_security_access(20) = 0  THEN
	cb_new.visible = false
	r_new.visible = false
END IF
...
public function integer of_hide_mod_fields (integer ai_view);//Start Code Change ----04.12.2016 #V15 maha - for 15.2
 //called from search button and of_search()
integer r
integer rc
integer vis
integer li_ssn
...
lds_fields.dataobject = "d_data_view_search_fields"
lds_fields.settransobject(sqlca)

li_ssn = of_get_app_setting("set_42","I") //hide ssn setting

//debugbreak()
rc = lds_fields.retrieve(ai_view)
//dw_search.setredraw( False)
for r = 1 to rc
	ls_field = lds_fields.getitemstring(r,"field_name")
	ls_label = lds_fields.getitemstring(r,"field_label")
	vis = lds_fields.getitemnumber(r,"field_visible")
	
	//---------Begin Added by (Appeon)Stephen 02.04.2017 for Issue with Search results Setup--------
	if ls_field = 'name_suffix' then
		if dw_search.dataobject = 'd_extended_search_list' then			
		else
			ls_field = 'code_lookup_code'
		end if
	end if
	if ls_field = 'prof_suffix' then
		if dw_search.dataobject = 'd_extended_search_list' then			
		else
			ls_field = 'code_lookup_prof_code'
		end if
	end if
	//---------End Added ------------------------------------------------------
	if ls_field  = "ssn" and li_ssn > 0 then vis = 0
	if ls_field  = "date_of_birth" and li_ssn = 1 then vis = 0
	
	If vis = 0 then
		dw_search.modify( ls_field + ".visible = false")
	Else
		dw_search.modify( ls_field + ".visible = true")
		dw_search.modify( ls_field + "_t.text = '" + ls_label + "'")
	End If

next
//dw_search.setredraw( True)  //Start Code Change ----07.28.2016 #V152 maha - will be called in the ue_setredraw

destroy n_ds
return 1
end function

public function integer of_set_app_filter ();//Start Code Change ----06.20.2016 #V152 maha
if gs_cust_type = "I" then
	rb_appr.visible = true
	rb_ver.visible = false
	rb_de.text = "D/E Compl"
end if
...
dw_search.Modify("DataWindow.Zoom=" + string(gi_zoom))  
uo_grid.dw_data.Modify("DataWindow.Zoom=" + string(gi_zoom))  
end subroutine

on pfc_cst_u_extended_search.create
this.cb_grid=create cb_grid
this.cb_adv=create cb_adv
...
this.dw_tasksxxx=create dw_tasksxxx
this.uo_grid=create uo_grid
this.gb_status=create gb_status
this.st_hide=create st_hide
this.st_dw_search_border=create st_dw_search_border
this.cb_close=create cb_close
this.Control[]={this.cb_grid,&
this.cb_adv,&
this.cb_dept_help,&
...
this.gb_status,&
this.st_hide,&
this.st_dw_search_border,&
this.cb_close}
end on

on pfc_cst_u_extended_search.destroy
destroy(this.cb_grid)
destroy(this.cb_adv)
...
destroy(this.rb_aud)
destroy(this.dw_tasksxxx)
destroy(this.uo_grid)
destroy(this.gb_status)
destroy(this.st_hide)
destroy(this.st_dw_search_border)
...
if gs_cust_type = "I" then
//	rb_appr.x = rb_ver.x  //Start Code Change ----06.20.2016 #V152 maha -removed
	rb_appr.text = "Affil"
	 //Start Code Change ----06.20.2016 #V152 maha - additional modifications
//	rb_ver.visible = false maha removed not needed
	rb_de.x = 2450
	rb_de.width = 400
...
string text = "Show Actions"
end type

event clicked; //Start Code Change ----04.20.2015 #V15 maha
if this.text = "Show Actions" then
	ib_show_grid = true
...
type r_new from rectangle within pfc_cst_u_extended_search
long linecolor = 28311551
integer linethickness = 4
long fillcolor = 28311551
integer x = 3534
integer y = 36
integer width = 357
integer height = 108
...
string item[] = {"Last Name / Entity","Prac ID","SS #","NPI #","Provider ID","Primary Department","Custom Search","Apps Needing Printing","Address - Street 1","Address - Street 2","Address - Tax Id","Standing/Flag","WebView Tracking (name)","Professional Suffix","Assigned User","Contract","CAQH ID"}
...
if this.text = "WebView Tracking (name)" then  //Start Code Change ----08.25.2011 #V11 maha 
	st_hide.bringtotop = true   //Start Code Change ----05.28.2015 #V15 maha - added hide for more controls
else
	st_hide.bringtotop = false
end if
...
choose case this.text
	case "Address - Tax Id", "NPI #" , "SS #"
		...
		if ib_advanced = true then cbx_valid.visible = true //(Appeon)Harry 08.19.2016 - BugH040801
	case else 
		cbx_valid.visible = false
end choose
...
event itemchanged;call super::itemchanged;of_hide_mod_fields( integer(data))
end event
...
integer taborder = 10
boolean bringtotop = true
string dataobject = "d_departments_lookup_white"
boolean border = false
boolean livescroll = true
end type
...
iw_prac_folder.il_affil_rec_id = 0 //Reset il_affil_rec_id, Added by Appeon long.zhang 06.18.2015 (Refresh issue when adding a new provider and completing Case#55391 Bug_Id 4566)
...
//if chk = 1 then
	...
	if gl_prac_id > 0 then 
		...
		If UpperBound(lst_ids.l_ids[]) = 1 Then iw_prac_folder.il_affil_rec_id = lst_ids.l_ids[1] //Set il_affil_rec_id, Added by Appeon long.zhang 06.18.2015 (Refresh issue when adding a new provider and completing Case#55391 Bug_Id 4566)
...
event modified; //Start Code Change ----10.23.2015 #V15 maha
//string s
//string f
//
//s = this.text
//
//f = 'upper(last_name) like "' + upper(s) + '%"'
//
//dw_search.setfilter(f)
//
//dw_search.filter()
end event
...
//	This.SelectRow(This.GetRow(), True)
	...
	//<$>reason:V14.2 Applause Bug # 4829 - Previous provider details are shown when there is no search result
	...
	// if isvalid( iw_prac_folder) then iw_prac_folder.of_get_photo_data(0,0) //SK Practitioner Folder - alfee 08.31.2010	 	 
	 If isvalid(iw_prac_folder) Then
		iw_prac_folder.il_prac_id = 0
		iw_prac_folder.ii_parent_facility_id = 0
		
		//Reset title
		iw_prac_folder.of_setup_title_search()
		
		//Reset phota and data.
		iw_prac_folder.of_get_photo_data(0,0)
	End If
	 //------------------- APPEON END -------------------
END IF
...
// RP Added 1.6.2016
this.event post resize(0, this.width, this.height)

this.Modify("DataWindow.Zoom=" + string(gi_zoom))   //Start Code Change ----07.13.2017 #V154 maha
//IF This.RowCount() > 0 THEN
...
long ll_prac
long ll_facil //maha 06.24.10
long ll_appt_rec //maha 06.02.2015
DataWindowChild dwchild
...
//	ll_facil = this.getitemnumber(1,"parent_facility_id")
	...
	if this.dataobject <> "d_extended_search_list_intelliapp" then  //Start Code Change ----03.03.2016 #V15 maha - error trap
		ll_appt_rec = this.getitemnumber(currentrow,"pd_affil_stat_rec_id")
	end if
	if ii_user_view > 0 then //maha 073103 check user default view
		dw_view.GetChild( "data_view_id", dwchild )
		li_found = dwchild.Find( "data_view_id = " + String( ii_user_view ),1, 1000 )
	...
	if isvalid(iw_prac_folder) then
		...
		if ll_prac > 0 then 
			...
			// dw_tasks.retrieve(ll_prac,gs_user_id)   //Start Code Change ----03.31.2015 #V15 maha
			  //dw_tasks.retrieve(ll_prac)   //Start Code Change ----03.31.2015 #V15 maha
			 //dw_tasks.expandall()
			 uo_grid.il_prac = ll_prac
			 uo_grid.il_facility = ll_facil
			 uo_grid.il_appt_rec = ll_appt_rec
			uo_grid.of_retrieve_data()
		else
			 iw_prac_folder.of_get_photo_data(0,0)
			  //dw_tasks.reset()   //Start Code Change ----03.31.2015 #V15 maha
			  uo_grid.il_prac = 0
			  uo_grid.il_facility = 0
			   uo_grid.il_appt_rec = 0
			  uo_grid.of_retrieve_data()
		end if
		//End Code Change ----06.17.2010
	end if

	//of_hide_mod_fields(li_default_data_view_id )  //Start Code Change ----04.12.2016 #V15 maha - for 15.2
...
event resize;call super::resize;//st_dw_search_border.width = this.width + 9
//st_dw_search_border.height = this.height + 8
end event

event buttonclicked;call super::buttonclicked;//Start Code Change ----01.11.2016 #V15 maha //Copied from v14.2 by Appeon long.zhang 03.11.2016 (BugL031101)
...
type dw_tasksxxx from u_dw within pfc_cst_u_extended_search
string tag = "d_search_prac_tasks"
boolean visible = false
integer x = 791
integer y = 1904
integer width = 233
...
integer taborder = 450
boolean bringtotop = true
string title = "d_search_prac_tasksd_net_dev_tv_w_loc"
string dataobject = "d_tv_smokey"
end type
...
on uo_grid.destroy
call u_search_screen_grid::destroy
end on
