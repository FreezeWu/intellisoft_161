$PBExportHeader$w_user_documents_admin.srw
forward
global type w_user_documents_admin from w_main
end type
type st_1 from statictext within w_user_documents_admin
end type
type dw_user from u_dw within w_user_documents_admin
end type
type cb_reload from commandbutton within w_user_documents_admin
end type
type cb_delete from commandbutton within w_user_documents_admin
end type
type cb_save from commandbutton within w_user_documents_admin
end type
type cb_view from commandbutton within w_user_documents_admin
end type
type cb_add from commandbutton within w_user_documents_admin
end type
type cb_close from commandbutton within w_user_documents_admin
end type
type dw_detail from u_dw within w_user_documents_admin
end type
type dw_browse from u_dw within w_user_documents_admin
end type
type gb_1 from groupbox within w_user_documents_admin
end type
end forward
...
integer width = 4722
integer height = 2356
string title = "User Documents Admin"
...
global w_user_documents_admin w_user_documents_admin
...
public function integer of_filter (); //Start Code Change ----01.27.2017 #V153 maha
 string s
...
on w_user_documents_admin.create
int iCurrent
call super::create
...
this.Control[iCurrent+2]=this.dw_user
this.Control[iCurrent+3]=this.cb_reload
...
on w_user_documents_admin.destroy
call super::destroy
destroy(this.st_1)
...
string title = "Detail"
string dataobject = "d_user_docs_detail_admin"
boolean livescroll = false
end type
...
string dataobject = "d_user_docs_browse_admin"
