$PBExportHeader$w_security_roles_painter.srw
forward
global type w_security_roles_painter from w_response
end type
type cb_rename from commandbutton within w_security_roles_painter
end type
type cb_close from u_cb within w_security_roles_painter
end type
type cb_delete from u_cb within w_security_roles_painter
end type
type cb_copy from u_cb within w_security_roles_painter
end type
type cb_new from u_cb within w_security_roles_painter
end type
type dw_select_role from u_dw within w_security_roles_painter
end type
type tab_security from tab within w_security_roles_painter
end type
...
type gb_select from groupbox within w_security_roles_painter
end type
end forward
...
global w_security_roles_painter w_security_roles_painter
...
on w_security_roles_painter.create
int iCurrent
call super::create
...
on w_security_roles_painter.destroy
call super::destroy
