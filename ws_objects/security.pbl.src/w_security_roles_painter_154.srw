$PBExportHeader$w_security_roles_painter_154.srw
forward
global type w_security_roles_painter_154 from w_response
end type
type cb_rename from commandbutton within w_security_roles_painter_154
end type
type cb_close from u_cb within w_security_roles_painter_154
end type
type cb_delete from u_cb within w_security_roles_painter_154
end type
type cb_copy from u_cb within w_security_roles_painter_154
end type
type cb_new from u_cb within w_security_roles_painter_154
end type
type dw_select_role from u_dw within w_security_roles_painter_154
end type
type tab_security from tab within w_security_roles_painter_154
end type
...
type gb_select from groupbox within w_security_roles_painter_154
end type
end forward
...
global w_security_roles_painter_154 w_security_roles_painter_154
...
on w_security_roles_painter_154.create
int iCurrent
call super::create
...
on w_security_roles_painter_154.destroy
call super::destroy
...
ii_id = Integer(data)
*/
tab_security.tabpage_roles.uo_roles.ii_id = Integer(data)
ib_retrieve = True
//---------------------------- APPEON END ----------------------------
...
//$<modification> Have the application does not trigger the RowFocusChanging and RowFocusChanged event
//$<modification> since it is unnecessary to trigger RowFocusChanging and RowFocusChanged in ItemChanged. 
//$<modification> Refer to PT-10/12 for more information.
/*
dw_modules.Retrieve( )
*/
...
If tab_security.SelectedTab = 1 Then
	...
	tab_security.tabpage_roles.uo_roles.dw_modules.Retrieve( )
...
ElseIf tab_security.SelectedTab = 3 Then
	of_contract_management_rights(tab_security.tabpage_roles.uo_roles.ii_id)
ElseIf tab_security.SelectedTab = 4 Then	//To Do List by Allen
	tab_security.tabpage_tdl.uo_tdl.of_refresh(tab_security.tabpage_roles.uo_roles.ii_id)
END IF
//---------------------------- APPEON END ----------------------------
