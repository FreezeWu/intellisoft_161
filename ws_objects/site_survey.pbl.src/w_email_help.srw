...
type cb_1 from commandbutton within w_email_help
end type
...
long backcolor = 33551856
string text = "Email: thuang@intellisoftgroup.com"
...
long textcolor = 33554432
long backcolor = 33551856
string text = "Email address of the user, for example, jdamelio@intellisoftgroup.com (must be the full email address)"
boolean focusrectangle = false
end type
