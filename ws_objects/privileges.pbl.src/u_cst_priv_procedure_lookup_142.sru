$PBExportHeader$u_cst_priv_procedure_lookup_142.sru
forward
global type u_cst_priv_procedure_lookup_142 from u_base
end type
type st_add from statictext within u_cst_priv_procedure_lookup_142
end type
type st_6 from statictext within u_cst_priv_procedure_lookup_142
end type
type rb_req from radiobutton within u_cst_priv_procedure_lookup_142
end type
type rb_pro from radiobutton within u_cst_priv_procedure_lookup_142
end type
type sle_find from singlelineedit within u_cst_priv_procedure_lookup_142
end type
type cb_find from commandbutton within u_cst_priv_procedure_lookup_142
end type
type st_5 from statictext within u_cst_priv_procedure_lookup_142
end type
type cbx_cca from checkbox within u_cst_priv_procedure_lookup_142
end type
type cb_sort from commandbutton within u_cst_priv_procedure_lookup_142
end type
type cb_clear from commandbutton within u_cst_priv_procedure_lookup_142
end type
type dw_status from datawindow within u_cst_priv_procedure_lookup_142
end type
type cb_save from commandbutton within u_cst_priv_procedure_lookup_142
end type
type dw_ca from datawindow within u_cst_priv_procedure_lookup_142
end type
type dw_section from datawindow within u_cst_priv_procedure_lookup_142
end type
type st_1 from statictext within u_cst_priv_procedure_lookup_142
end type
type st_2 from statictext within u_cst_priv_procedure_lookup_142
end type
type cb_addfilter from commandbutton within u_cst_priv_procedure_lookup_142
end type
type dw_facility from datawindow within u_cst_priv_procedure_lookup_142
end type
type st_3 from statictext within u_cst_priv_procedure_lookup_142
end type
type st_4 from statictext within u_cst_priv_procedure_lookup_142
end type
type dw_detail from u_dw within u_cst_priv_procedure_lookup_142
end type
type cb_delete from commandbutton within u_cst_priv_procedure_lookup_142
end type
type cb_copy from commandbutton within u_cst_priv_procedure_lookup_142
end type
type cb_add from commandbutton within u_cst_priv_procedure_lookup_142
end type
type cb_close from commandbutton within u_cst_priv_procedure_lookup_142
end type
type dw_browse from u_dw within u_cst_priv_procedure_lookup_142
end type
type cb_select from commandbutton within u_cst_priv_procedure_lookup_142
end type
type gb_1 from groupbox within u_cst_priv_procedure_lookup_142
end type
end forward
...
global u_cst_priv_procedure_lookup_142 u_cst_priv_procedure_lookup_142
...
on u_cst_priv_procedure_lookup_142.create
int iCurrent
call super::create
...
on u_cst_priv_procedure_lookup_142.destroy
call super::destroy
destroy(this.st_add)
destroy(this.st_6)
destroy(this.rb_req)
