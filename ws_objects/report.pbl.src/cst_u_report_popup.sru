$PBExportHeader$cst_u_report_popup.sru
forward
global type cst_u_report_popup from u_tabpg
end type
type cb_8 from uo_cb_output within cst_u_report_popup
end type
type ddlb_zoom from dropdownlistbox within cst_u_report_popup
end type
type st_rec_cnt from statictext within cst_u_report_popup
end type
type st_page from statictext within cst_u_report_popup
end type
type cb_next_page from commandbutton within cst_u_report_popup
end type
type cb_prior_page from commandbutton within cst_u_report_popup
end type
type cb_7 from commandbutton within cst_u_report_popup
end type
type cb_6 from commandbutton within cst_u_report_popup
end type
type cb_5 from commandbutton within cst_u_report_popup
end type
type cb_4 from commandbutton within cst_u_report_popup
end type
type cb_3 from commandbutton within cst_u_report_popup
end type
type cb_prac_filt from commandbutton within cst_u_report_popup
end type
type cb_export from commandbutton within cst_u_report_popup
end type
type cb_1 from commandbutton within cst_u_report_popup
end type
type cb_sort from commandbutton within cst_u_report_popup
end type
type cb_2 from commandbutton within cst_u_report_popup
end type
type cbx_primary_onlyxxx from checkbox within cst_u_report_popup
end type
type dw_report from u_dw within cst_u_report_popup
end type
end forward
...
global cst_u_report_popup cst_u_report_popup
...
this.Control[iCurrent+17]=this.cbx_primary_onlyxxx
this.Control[iCurrent+18]=this.dw_report
end on

on cst_u_report_popup.destroy
call super::destroy
destroy(this.cb_8)
