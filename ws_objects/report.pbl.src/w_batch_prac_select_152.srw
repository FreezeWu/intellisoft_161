$PBExportHeader$w_batch_prac_select_152.srw
forward
global type w_batch_prac_select_152 from window
end type
type uo_1 from pfc_cst_u_prac_batch_search_152 within w_batch_prac_select_152
end type
end forward
...
global w_batch_prac_select_152 w_batch_prac_select_152
...
on w_batch_prac_select_152.create
this.uo_1=create uo_1
this.Control[]={this.uo_1}
end on

on w_batch_prac_select_152.destroy
destroy(this.uo_1)
end on
...
this.height= uo_1.height + 150  //set the height if security changed the uo height
//end if
...
on uo_1.destroy
call pfc_cst_u_prac_batch_search_152::destroy
end on
