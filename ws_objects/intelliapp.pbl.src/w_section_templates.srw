$PBExportHeader$w_section_templates.srw
forward
global type w_section_templates from w_response
end type
type st_new from statictext within w_section_templates
end type
type cb_1 from commandbutton within w_section_templates
end type
type cb_save from commandbutton within w_section_templates
end type
type cb_apply from commandbutton within w_section_templates
end type
type dw_templates from u_dw within w_section_templates
end type
type sle_saveas from singlelineedit within w_section_templates
end type
type st_1 from statictext within w_section_templates
end type
type cb_close from commandbutton within w_section_templates
end type
type cb_delete from commandbutton within w_section_templates
end type
type cbx_select from checkbox within w_section_templates
end type
type dw_temp_flds from u_dw within w_section_templates
end type
type cb_del_field from commandbutton within w_section_templates
end type
type cb_2 from commandbutton within w_section_templates
end type
type cb_interview from commandbutton within w_section_templates
end type
type dw_order from datawindow within w_section_templates
end type
type gb_2 from groupbox within w_section_templates
end type
type gb_place from groupbox within w_section_templates
end type
end forward
...
global w_section_templates w_section_templates
...
this.Control[iCurrent+1]=this.st_new
this.Control[iCurrent+2]=this.cb_1
this.Control[iCurrent+3]=this.cb_save
this.Control[iCurrent+4]=this.cb_apply
this.Control[iCurrent+5]=this.dw_templates
this.Control[iCurrent+6]=this.sle_saveas
this.Control[iCurrent+7]=this.st_1
this.Control[iCurrent+8]=this.cb_close
this.Control[iCurrent+9]=this.cb_delete
this.Control[iCurrent+10]=this.cbx_select
this.Control[iCurrent+11]=this.dw_temp_flds
this.Control[iCurrent+12]=this.cb_del_field
this.Control[iCurrent+13]=this.cb_2
this.Control[iCurrent+14]=this.cb_interview
this.Control[iCurrent+15]=this.dw_order
this.Control[iCurrent+16]=this.gb_2
this.Control[iCurrent+17]=this.gb_place
end on

on w_section_templates.destroy
call super::destroy
destroy(this.st_new)
destroy(this.cb_1)
...
long backcolor = 33551856
string text = "Select the existing mapped fields for this template"
...
event clicked;//Start Code Change ----04.28.2008 #V8 maha - new button replaces checkbox
st_new.visible = true
parent.height = 500
gb_place.visible = false
