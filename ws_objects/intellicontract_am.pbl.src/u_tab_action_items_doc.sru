$PBExportHeader$u_tab_action_items_doc.sru
$PBExportComments$[intellicontract_tab]  The action Items Tab on the action items window
forward
global type u_tab_action_items_doc from u_tab
end type
type tabpage_1 from u_tabpage_ctx_doc_graph within u_tab_action_items_doc
end type
type tabpage_1 from u_tabpage_ctx_doc_graph within u_tab_action_items_doc
end type
type tabpage_2 from u_tabpage_ctx_doc_details within u_tab_action_items_doc
end type
type tabpage_2 from u_tabpage_ctx_doc_details within u_tab_action_items_doc
end type
end forward
...
global u_tab_action_items_doc u_tab_action_items_doc
...
on u_tab_action_items_doc.create
...
on u_tab_action_items_doc.destroy
call super::destroy
