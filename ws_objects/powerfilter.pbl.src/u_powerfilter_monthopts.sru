...
END IF
this.y = iu_powerfilter_predeffilters.y + (88 * (iu_powerfilter_predeffilters.dw_1.rowcount() - 1)) + 4
...
CHOOSE CASE Lower(ls_FilterType)
	...
	CASE 'december'
		...
		ls_Parm1 = '12'
END CHOOSE		
ls_PowerTip = ls_displaytext //set the PowerTip based on the PreDefined Label display text field for multi language support
