...
'background.mode="2" background.color="0" background.transparency="0" background.gradient.color="0" ' + &
...
'tooltip.backcolor="0" tooltip.delay.initial="0" tooltip.delay.visible="32000" tooltip.enabled="0" tooltip.hasclosebutton="0" ' + &
'tooltip.icon="0" tooltip.isbubble="0" tooltip.maxwidth="0" tooltip.textcolor="0" tooltip.transparency="0" transparency="0" )')
...
ls_DisplayText = This.GetItemString(li_row,'displaytext')
CHOOSE CASE Lower(ls_FilterType)
	...
	CASE 'above average'
		...
		ls_PowerTip = ls_DisplayText + '.~r~n~r~n(' + is_averageis + ' ' + String(ld_average,'#,##0.00') +')' //set the PowerTip based on the PreDefined Label //MULTILANG Average is
		ls_Filter1 = 'Is Greater Than'
	CASE 'below average'
		ld_average = of_GetAverage()
		ls_parm1 = String(ld_average) 
		...
		ls_Filter1 = 'Is Less Than'
	CASE 'tomorrow'
		ls_PowerTip = ls_DisplayText //set the PowerTip based on the PreDefined Label
